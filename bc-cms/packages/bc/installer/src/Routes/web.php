...
Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'BC\Installer\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'BC\Installer\Controllers', 'middleware' => 'web'], function () {
