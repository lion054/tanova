                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" v-model="ticket_types[index].number"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-4">
                                            <label><?php echo e(__('Price')); ?></label>
                                            <input type="text" v-model="ticket_types[index].price"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Event/Views/admin/availability.blade.php ENDPATH**/ ?>