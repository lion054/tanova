                    ...
                    <div class="row justify-center text-center">
                        <div class="col-auto">
                            <div class="sectionTitle -md">
                                ...
                                <p class=" sectionTitle__text mt-5 sm:mt-0 d-none">Tsoka makes every travel operator AI-native — from bookings to payouts, your business runs itself.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <?php if($rows->count() > 0): ?>
                            <div class="list-news">
                                ...
                                <div class="bc-pagination">
                                    <?php echo e($rows->appends(request()->query())->links('Layout::global.livewire.pagination')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/News/Views/frontend/index.blade.php ENDPATH**/ ?>