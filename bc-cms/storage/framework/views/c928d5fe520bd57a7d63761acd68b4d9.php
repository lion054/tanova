                        ...
                        <div class="roomGrid__grid">
                            <div>
                                <div class="ratio ratio-1:1" @click="showGallery($event,room.id,room.gallery)">
                                    <img v-bind:src="room.image" alt="image" class="img-ratio rounded-4">
                                ...
                                <div class="modal" v-bind:id="'modal_room_'+room.id" tabindex="-1" role="dialog">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Hotel/Views/frontend/layouts/details/hotel-room-list.blade.php ENDPATH**/ ?>