<?php if(is_default_lang()): ?>
                ...
                <div class="form-controls">
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            ?>
                            <?php $__currentLoopData = $property_map_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item" data-number="<?php echo e($key); ?>">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <select name="property_map_search_fields[<?php echo e($key); ?>][field]" class="custom-select">
                                            ...
                                            <br>
                                            <select name="property_map_search_fields[<?php echo e($key); ?>][attr]" class="mt-2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="property_map_search_fields[<?php echo e($key); ?>][position]" min="0" value="<?php echo e($item['position'] ?? 0); ?>" class="form-control">
                                            <label ><?php echo e(__("Size")); ?></label>
                                            <select name="property_map_search_fields[<?php echo e($key); ?>][size]" class="custom-select">
                                                <option value=""><?php echo e(__("-- Select Size --")); ?></option>
                                                <?php $__currentLoopData = range(1,12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if(($item['size'] ?? '') == $size): ?> selected <?php endif; ?> value="<?php echo e($size); ?>"><?php echo e($size); ?>/12</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-1">
                            ...
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <label ><?php echo e(__("Size")); ?></label>
                                        <select __name__="property_map_search_fields[__number__][size]" class="custom-select">
                                            <option value=""><?php echo e(__("-- Select Size --")); ?></option>
                                            <?php $__currentLoopData = range(1,12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($size); ?>"><?php echo e($size); ?>/12</option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-1">
    ...
    <hr>
<?php endif; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Property/Views/admin/settings/map-search.blade.php ENDPATH**/ ?>