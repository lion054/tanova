...
<div class="bc_single_book_wrap d-flex justify-end js-pin-content <?php if(setting_item('event_enable_inbox')): ?> has-vendor-box <?php endif; ?>"
    data-offset="120">
    <div class="w-360 lg:w-full d-flex flex-column items-center">
        <div class="bc_single_book px-30 py-30 rounded-4 border-light bg-white shadow-4">
            ...
            <div id="bc_event_book_app" v-cloak>
...
<?php echo $__env->make('Booking::frontend.global.enquiry-form', ['service_type' => 'event'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Event/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>