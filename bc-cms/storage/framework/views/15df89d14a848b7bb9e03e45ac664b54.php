...
?>
<form action="<?php echo e(route('flight.search')); ?>" class="gotrip_form_search bc_form_search bc_form form <?php echo e($classes); ?>"
    method="get">
                ...
                <?php $__currentLoopData = $flight_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-<?php echo e($field['size'] ?? '6'); ?> align-self-center px-30 lg:py-20 lg:px-0">
                        ...
                        <?php switch($field['field']):
                            ...
                            <?php case ('seat_type'): ?>
                                <?php echo $__env->make('Layout::common.search.fields.seat_type', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php break; ?>

                            <?php case ('from_where'): ?>
                                <?php echo $__env->make('Layout::common.search.fields.location', [
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Flight/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>