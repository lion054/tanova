...
<?php $__env->startSection('content'); ?>
    <div class="bc_detail bc_hotel_detail">
        ...
        <div class="bc_content">
            ...
            <div class="container">
                <?php echo $__env->make('Hotel::frontend.layouts.details.hotel-rules-policy', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            ...
            <?php echo $__env->make('Hotel::frontend.layouts.details.hotel-related', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
            ...
            <div class="container">
                ...
                <div class="right">
                    <?php if($row->getBookingEnquiryType() === 'book'): ?>
                        <a
                            class="rounded-4 bg-blue-1 text-white cursor-pointer btn-primary gotrip-detail-hotel-book-mobile"><?php echo e(__('Book Now')); ?></a>
                    <?php else: ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('module/hotel/js/single-hotel.js?_ver=' . config('app.asset_version'))); ?>">
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Hotel/Views/frontend/detail.blade.php ENDPATH**/ ?>