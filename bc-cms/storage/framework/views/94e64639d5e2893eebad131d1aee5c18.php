<?php $style = $style ?? 'default';
    ...
    if ($style == 'car_carousel') {
        $classes =
            ' mainSearch -col-5 -w-1070 mx-auto bg-white pr-20 py-20 lg:px-20 lg:pt-5 lg:pb-20 rounded-4 shadow-1';
        $button_classes = ' -dark-1 py-15 px-35 h-60 col-12 rounded-4 bg-dark-1 text-white';
    }
?>

<form action="<?php echo e(route('car.search')); ?>"
    class="gotrip_form_search bc_form_search bc_form form-search-all-service form <?php echo e($classes); ?>" method="get">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Car/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>