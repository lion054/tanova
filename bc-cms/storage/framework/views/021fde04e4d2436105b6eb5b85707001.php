<div>
    <div class="sidebar__item -no-border mb-30 lg:d-none">
        <div class="px-20 py-20 bg-light-2 rounded-4">
            <h5 class="text-18 fw-500 mb-10"><?php echo e(setting_item_with_lang('visa_page_search_title')); ?></h5>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('visa::search-form', ['layout' => 'vertical']);

$__html = app('livewire')->mount($__name, $__params, 'lw-4123637583-1', $__slots ?? [], get_defined_vars());
                ...
                <div class="row x-gap-10 y-gap-30">
                    <div class="col-12">
                        <div class="js-price-searchPage">
                            ...
                            <button type="submit"
                                class="flex-center bg-blue-1 rounded-4 px-3 py-1 mt-3 text-12 fw-600 text-white btn-apply-price-range mt-20 d-none"><?php echo e(__('APPLY')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
window.priceRangeVisaSidebar = function() {
    ...
    ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Visa/Views/frontend/components/filter/index.blade.php ENDPATH**/ ?>