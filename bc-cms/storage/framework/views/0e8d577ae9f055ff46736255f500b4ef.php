...
<?php $__env->startPush('css'); ?>
    ...
    <style type="text/css">
        ...
        .bc_wrap .bc_search_boat .bc_form_search {
            margin-top: 0px;
            margin-bottom: 0px;
        }
    </style>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="halfMap mt-0 bc_search_boat">
        <h1 class="d-none">
            <?php echo e(setting_item_with_lang('boat_page_search_title')); ?>

        </h1>
        <div class="halfMap__content">
            <div class="bc_form_search_map boat_form_search_map form-search-all-service">
                <div class="mainSearch bg-white pr-10 py-10 lg:px-20 lg:pt-5 lg:pb-20 bg-light-2 rounded-4">
                    <?php echo $__env->make('Boat::frontend.layouts.search.form-search', ['style' => 'map'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
            <div class="bc_filter_search_map" id="advance_filters">
                <?php echo $__env->make('Boat::frontend.layouts.search-map.filter-search-map', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            ...
            <div class="row y-gap-10 justify-between items-center pt-20">
                ...
                <div class="col-auto bc-form-order">
                    <?php echo $__env->make('Layout::global.search.orderby', [
                        'routeName' => 'boat.search',
                        'hidden_map_button' => 1,
                    ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
            <div class="ajax-search-result">
                <?php echo $__env->make('Boat::frontend.ajax.search-result-map', ['layout' => 'normal'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Boat/Views/frontend/search-map.blade.php ENDPATH**/ ?>