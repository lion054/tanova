                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="sms_driver" class="form-control">
                                <?php $__currentLoopData = \Modules\Core\SettingClass::UPLOAD_DRIVER; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>" <?php echo e(setting_item('upload_drive') == $value ? 'selected' : ''); ?>><?php echo e(__(strtoupper($value))); ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="SmsAdminEventCreateBooking">
                            <?php if(is_default_lang()): ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_admin_has_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_admin_has_booking" value="1"> <?php echo e(__("Enable send sms to Administrator when have booking?")); ?></label>
                                </div>
                            <?php else: ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_admin_has_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_admin_has_booking" disabled value="1"> <?php echo e(__("Enable send sms to Administrator when have booking?")); ?></label>
                                </div>
                                <?php if($settings['enable_sms_admin_has_booking'] != 1): ?>
                        ...
                        <div class="tab-pane" id="SmsVendorEventCreateBooking">
                            <?php if(is_default_lang()): ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_vendor_has_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_vendor_has_booking" value="1"> <?php echo e(__("Enable send sms to Vendor when have booking?")); ?></label>
                                </div>
                            <?php else: ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_vendor_has_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_vendor_has_booking" disabled value="1"> <?php echo e(__("Enable send sms to Vendor when have booking?")); ?></label>
                                </div>
                                <?php if($settings['enable_sms_vendor_has_booking'] != 1): ?>
                                    <p><?php echo e(__('You must enable on main lang.')); ?></p>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="tab-pane" id="SmsUserEventCreateBooking">
                            <?php if(is_default_lang()): ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_user_has_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_user_has_booking" value="1"> <?php echo e(__("Enable send sms to Customer when have booking?")); ?></label>
                                </div>
                            <?php else: ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_user_has_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_user_has_booking" disabled value="1"> <?php echo e(__("Enable send sms to Customer when have booking?")); ?></label>
                                </div>
                                <?php if($settings['enable_sms_user_has_booking'] != 1): ?>
                                    <p><?php echo e(__('You must enable on main lang.')); ?></p>
                                <?php endif; ?>
                            <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="SmsAdminEventUpdateBooking">
                            <?php if(is_default_lang()): ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_admin_update_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_admin_update_booking" value="1"> <?php echo e(__("Enable send sms to Administrator when update booking?")); ?></label>
                                </div>
                            <?php else: ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_admin_update_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_admin_update_booking" disabled value="1"> <?php echo e(__("Enable send sms to Administrator when update booking?")); ?></label>
                                </div>
                                <?php if(@$settings['enable_sms_admin_update_booking'] != 1): ?>
                                    <p><?php echo e(__('You must enable on main lang.')); ?></p>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="tab-pane" id="SmsVendorEventUpdateBooking">
                            <?php if(is_default_lang()): ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_vendor_update_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_vendor_update_booking" value="1"> <?php echo e(__("Enable send sms to Vendor when update booking?")); ?></label>
                                </div>
                            <?php else: ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if(@$settings['enable_sms_vendor_update_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_vendor_update_booking" disabled value="1"> <?php echo e(__("Enable send sms to Vendor when update booking?")); ?></label>
                                </div>
                                <?php if(@$settings['enable_sms_vendor_update_booking'] != 1): ?>
                                    <p><?php echo e(__('You must enable on main lang.')); ?></p>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="tab-pane" id="SmsUserEventUpdateBooking">
                            <?php if(is_default_lang()): ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if(@$settings['enable_sms_user_update_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_user_update_booking" value="1"> <?php echo e(__("Enable send sms to Customer when update booking?")); ?></label>
                                </div>
                            <?php else: ?>
                                <div class="form-group">
                                    <label> <input type="checkbox" <?php if($settings['enable_sms_user_has_booking'] ?? '' == 1): ?> checked <?php endif; ?> name="enable_sms_user_has_booking" disabled value="1"> <?php echo e(__("Enable send sms to Customer when update booking?")); ?></label>
                                </div>
                                <?php if(@$settings['enable_sms_user_update_booking'] != 1): ?>
                                    <p><?php echo e(__('You must enable on main lang.')); ?></p>
                                <?php endif; ?>
                            <?php endif; ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Core/Views/admin/settings/groups/uploads.blade.php ENDPATH**/ ?>