<?php $__env->startSection('title', __('Reset Password') . ' — ' . config('app.name', 'Tsoka Travel')); ?>
...
<div class="form-heading">
    ...
    <p><?php echo e(__('Remember it?')); ?> <a href="<?php echo e(route('login')); ?>"><?php echo e(__('Back to sign in')); ?></a></p>
</div>
...
<form method="POST" action="<?php echo e(route('password.email')); ?>">
    ...
    <button type="submit" class="btn-auth"><?php echo e(__('Send Reset Link')); ?></button>
</form>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>