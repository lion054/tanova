                        ...
                        <div class="item">
                            ...
                            <h4 class="name"><?php echo e($row->getDisplayName()); ?>
                                ...
                                <?php if($row->is_verified): ?>
                                    <img data-bs-toggle="tooltip" data-placement="top" src="<?php echo e(asset('icon/ico-vefified-1.svg')); ?>" title="<?php echo e(__("Verified")); ?>" alt="ico-vefified-1">
                                <?php else: ?>
                                    <img data-bs-toggle="tooltip" data-placement="top" src="<?php echo e(asset('icon/ico-not-vefified-1.svg')); ?>" title="<?php echo e(__("Not verified")); ?>" alt="ico-vefified-1">
                                <?php endif; ?>
                            </h4>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Vendor/Views/frontend/blocks/list-vendor/index.blade.php ENDPATH**/ ?>