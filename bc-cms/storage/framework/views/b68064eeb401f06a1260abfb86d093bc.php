...
<?php if(!empty($services) and $services->total()): ?>
    <div class="bc-profile-list-services">
        <?php echo $__env->make('Boat::frontend.blocks.list-boat.index', ['rows'=>$services,'style_list'=>'normal','desc'=>' ','title'=>!empty($view_all) ? __('Boat by :name',['name'=>$user->first_name]) :'','col'=>4], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Boat/Views/frontend/profile/service.blade.php ENDPATH**/ ?>