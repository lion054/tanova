        ...
        <div class="row dashboard-price-info row-eq-height mb-5">
            ...
            <div class="col-lg-3 col-md-3">
                <div class="dashboard-item">
                    <div class="wrap-box">
                        <div class="title">
                            <?php echo e("Pending Credit"); ?>

                        </div>
                        <div class="details">
                            <div class="number"><?php echo e(__(':amount',['amount'=>$row->pending_balance])); ?></div>
                        </div>
                        <?php if($row->pending_balance): ?>
                            <div class="desc">~ <?php echo e(format_money(credit_to_money($row->pending_balance))); ?> </div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/User/Views/frontend/wallet/index.blade.php ENDPATH**/ ?>