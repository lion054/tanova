    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-<?php echo e($value_col_size ?? 4); ?>">
            <?php if(empty($only_show_data)): ?>
                <input type="number" class="form-control" name="verify_data_<?php echo e($field['id']); ?>" value="<?php echo e($field['data']); ?>">
            <?php else: ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/User/Views/frontend/verification/fields/number.blade.php ENDPATH**/ ?>