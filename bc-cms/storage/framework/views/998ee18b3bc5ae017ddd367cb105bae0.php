<?php
    ...
    switch ($headerStyle) {
        case 'transparent':
            $headerClass = 'bg-green is-sticky';
            break;
        case 'transparent_v2':
            $headerClass = 'header_2';
            break;
        case 'transparent_v3':
            $headerClass = '-type-2';
            break;
        ...
        case 'normal_white':
            ...
            break;
        default:
            $headerClass = '-fixed bg-dark-3';
    }
?>
<?php switch($headerStyle):
    case ('transparent_v8'): ?>
        <?php echo $__env->make('Layout::parts.header-style.transparent_v8', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php break; ?>

    <?php default: ?>
        <header data-add-bg="<?php echo e($dataBg); ?>" class="header <?php echo e($headerClass); ?> js-header bc_header style-<?php echo e($headerStyle); ?>"
            data-x="header" data-x-toggle="is-menu-opened">
            <div data-anim="fade"
                class="<?php echo e($container_class ?? 'header__container'); ?> px-30 sm:px-20 <?php if($headerStyle == 'transparent_v2'): ?> container <?php endif; ?> is-in-view">
                <div class="row justify-between items-center">
                    <div class="col-auto <?php if($headerStyle == 'transparent_v7'): ?> col-left <?php endif; ?>">
                        <?php
                            ...
                            if ($headerStyle == 'transparent_v9') {
                                $logo = $logoDark;
                            }
                        ?>
                        <?php if($headerStyle == 'transparent_v2'): ?>
                            <?php echo $__env->make("Layout::parts.header-style.$headerStyle", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <div class="d-none xl:d-block">
                                <?php echo $__env->make('Layout::parts.header-style.normal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        <?php elseif($headerStyle == 'transparent_v4'): ?>
                            <?php echo $__env->make('Layout::parts.header-style.transparent_v2', [
                                'textColor' => 'text-dark-1',
                            ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php elseif($headerStyle == 'normal_white'): ?>
                            <?php echo $__env->make('Layout::parts.header-style.normal', ['textColor' => 'text-dark-1'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php else: ?>
                            <?php echo $__env->make('Layout::parts.header-style.normal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?>
                    </div>
                    <?php if($headerStyle == 'transparent_v3'): ?>
                        <div class="col-auto xl:d-none">
                            <a href="<?php echo e(url(app_get_locale(false, '/'))); ?>" class="header-logo mr-20" data-x="header-logo"
                                data-x-toggle="is-logo-dark">
                                <?php if($logo): ?>
                                    <img class="logo-light" src="<?php echo e(get_file_url($logo, 'full')); ?>"
                                        alt="<?php echo e(setting_item('site_title')); ?>">
                                <?php endif; ?>
                                <?php if($logoDark): ?>
                                    <img class="logo-dark" src="<?php echo e(get_file_url($logoDark, 'full')); ?>"
                                        alt="<?php echo e(setting_item('site_title')); ?>">
                                <?php endif; ?>
                            </a>
                        </div>
                    ...
                    <div class="col-auto">
                                ...
                                <div class="header-menu__content">
                                    <div class="menu js-navList">
                                        <ul class="menu__nav <?php echo e($navTextStyle); ?> -is-active">
                                            ...
                                            <?php echo $__env->make('Language::frontend.switcher-dropdown', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php if(!Auth::check()): ?>
                                                <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                                                    ...
                                                    <?php if(!empty(($page_vendor = get_page_url(setting_item('vendor_page_become_an_expert'))))): ?>
                                                        <a href="<?php echo e($page_vendor); ?>"
                                                            class="<?php echo e($btn_expert); ?> button px-30 fw-400 text-14  h-50"><?php echo e(__('Become An Expert')); ?></a>
                                                    <?php endif; ?>
                                                    <a data-bs-toggle="modal" href="#login"
                                                        class="<?php echo e($btn_login); ?> button px-30 fw-400 text-14  h-50 ml-20"><?php echo e(__('Sign In / Register')); ?></a>
                                                </div>
                                            <?php else: ?>
                                                <li class="login-item menu-item-has-children">
                                                    <a href="#" class="is_login">
                                                        <span class="mr-10">
                                                            <?php if($avatar_url = Auth::user()->getAvatarUrl()): ?>
                                                                <img class="avatar rounded-circle" src="<?php echo e($avatar_url); ?>"
                                                                    alt="<?php echo e(Auth::user()->getDisplayName()); ?>" width="30"
                                                                    height="30">
                                                            <?php else: ?>
                                                                <span
                                                                    class="avatar-text rounded-circle"><?php echo e(ucfirst(Auth::user()->getDisplayName()[0])); ?></span>
                                                            <?php endif; ?>
                                                    ...
                                                    <ul class="subnav">
                                                        <?php if(Auth::user()->hasPermission('dashboard_vendor_access')): ?>
                                                            <li><a href="<?php echo e(route('vendor.dashboard')); ?>"
                                                                    class="dropdown-item"><i class="fa fa-line-chart mr-10"></i>
                                                        ...
                                                        <li class="<?php if(Auth::user()->hasPermission('dashboard_vendor_access')): ?> menu-hr <?php endif; ?>">
                                                            <a href="<?php echo e(route('user.profile.index')); ?>"
                                                                class="dropdown-item"><i class="fa fa-address-card mr-10"></i>
                                                                <?php echo e(__('My profile')); ?></a>
                                                        </li>
                                                        <?php if(setting_item('inbox_enable')): ?>
                                                            <li class="menu-hr"><a href="<?php echo e(route('user.chat')); ?>"
                                                                    class="dropdown-item"><i class="fa fa-comments mr-10"></i>
                                                                    <?php echo e(__('Messages')); ?></a></li>
                                                        <?php endif; ?>
                                                        <li class="menu-hr"><a href="<?php echo e(route('user.booking_history')); ?>"
                                                                class="dropdown-item"><i class="fa fa-clock-o mr-10"></i>
                                                                <?php echo e(__('Booking History')); ?></a></li>
                                                        <li class="menu-hr"><a href="<?php echo e(route('user.change_password')); ?>"
                                                                class="dropdown-item"><i class="fa fa-lock mr-10"></i>
                                                                <?php echo e(__('Change password')); ?></a></li>
                                                        <?php if(Auth::user()->hasPermission('dashboard_access')): ?>
                                                            <li class="menu-hr"><a href="<?php echo e(route('admin.index')); ?>"
                                                                    class="dropdown-item"><i class="fa fa-dashboard mr-10"></i>
                                                                    <?php echo e(__('Admin Dashboard')); ?></a></li>
                                                        <?php endif; ?>
                                                        <li class="menu-hr">
                                                            <a class="dropdown-item" href="#"
                                                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                                                                    class="fa fa-sign-out mr-10"></i> <?php echo e(__('Logout')); ?></a>
                                                        </li>
                                                    </ul>
                                                        ...
                                                        <div class="login-mobile-item dropdown ml-20">
                                                            ...
                                                            <ul class="dropdown-menu text-left">
                                                                ...
                                                                <li class="menu-hr"><a
                                                                        ...
                                                                        class="dropdown-item"><i class="fa fa-clock-o"></i>
                                                                        <?php echo e(__('Booking History')); ?></a></li>
                                                                <li class="menu-hr"><a
                                                                        href="<?php echo e(route('user.change_password')); ?>"
                                                                        class="dropdown-item"><i class="fa fa-lock"></i>
                                                                        <?php echo e(__('Change password')); ?></a></li>
                                                                <?php if(Auth::user()->hasPermission('dashboard_access')): ?>
                                                                    <li class="menu-hr"><a href="<?php echo e(route('admin.index')); ?>"
                                                                            class="dropdown-item"><i
                        ...
                        <div class="d-none xl:d-flex x-gap-20 items-center pl-30 <?php echo e($navTextStyle); ?>"
                            data-x="header-mobile-icons" data-x-toggle="text-white">
                            <div><a href="<?php if(!Auth::check()): ?> <?php echo e(url('/login')); ?> <?php else: ?> <?php echo e(route('user.profile.index')); ?> <?php endif; ?>"
                                    class="d-flex items-center icon-user text-inherit text-22"></a></div>
...
<?php endswitch; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Layout/parts/header.blade.php ENDPATH**/ ?>