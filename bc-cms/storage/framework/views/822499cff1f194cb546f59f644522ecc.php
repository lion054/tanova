<tr>
    ...
    <td width="2%">
        ...
        <?php if(!empty(setting_item("event_allow_vendor_can_change_their_booking_status"))): ?>
            ...
            <div class="dropdown-menu">
                <?php if(!empty($statues)): ?>
                    <?php $__currentLoopData = $statues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route("event.vendor.booking_report.bulk_edit" , ['id'=>$booking->id , 'status'=>$status])); ?>">
        ...
        <?php endif; ?>
        <?php if(!empty(setting_item("event_allow_vendor_can_change_paid_amount"))): ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Event/Views/frontend/bookingReport/loop.blade.php ENDPATH**/ ?>