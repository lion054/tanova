<div class="bc_filter sidebar">
    <?php if($layout == 'grid'): ?>
        <div class="g-filter-item sidebar__item -no-border bc-form-search mb-30 lg:d-none">
            <div class="px-20 py-20 bg-light-2 rounded-4">
                ...
                <?php echo $__env->make('Space::frontend.layouts.search.form-search', ['style' => 'sidebar'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    <?php endif; ?>
    <form action="<?php echo e(route('space.search')); ?>" class="bc_form_filter lg:d-none" data-x="filterPopup"
        data-x-toggle="-is-active">

        <div
            class="g-filter-item sidebar__item <?php if(!$layout || $layout == 'normal'): ?> -no-border <?php endif; ?> pt-20 mb-30 lg:d-none">
            <div class="flex-center ratio ratio-15:9 js-lazy"
                data-bg="<?php echo e(get_file_url(setting_item('space_map_image'), 'full')); ?>">
                <a href="<?php echo e(route('space.search', ['_layout' => 'map'])); ?>"
                    class="button py-15 px-24 -blue-1 bg-white text-dark-1 absolute w-auto h-auto"
                    ...
                    <div class="col-12">
                        <div class="js-price-searchPage">
                            ...
                            <input type="hidden" class="filter-price irs-hidden-input" name="price_range"
                                ...
                                data-max="<?php echo e($price_max); ?>" data-from="<?php echo e($pri_from); ?>"
                                data-to="<?php echo e($pri_to); ?>" readonly="" value="<?php echo e($price_range); ?>">
                            ...
                            <button type="submit"
                                class="flex-center bg-blue-1 rounded-4 px-3 py-1 mt-3 text-12 fw-600 text-white btn-apply-price-range mt-20"><?php echo e(__('APPLY')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Space/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>