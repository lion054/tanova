<?php if($layout == 'grid'): ?>
    <div class="gotrip-form-search-grid rounded-4 mb-30">
        ...
        <?php echo $__env->make('Car::frontend.layouts.search.form-search', ['style' => 'sidebar'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
<?php endif; ?>
<form action="<?php echo e(url(app_get_locale(false, false, '/') . config('car.car_route_prefix'))); ?>"
    class="bc_form_filter bc_filter lg:d-none" data-x="filterPopup" data-x-toggle="-is-active">

    <div class="g-filter-item sidebar__item -no-border mb-30 lg:d-none">
        <div class="flex-center ratio ratio-15:9 js-lazy"
            data-bg="<?php echo e(get_file_url(setting_item('car_map_image'), 'full')); ?>">
            <a href="<?php echo e(route('car.search', ['_layout' => 'map'])); ?>"
                        ...
                        <div class="col-auto">
                            <div class="d-flex items-center">
                                <div class="form-checkbox ">
                                    <input <?php if(in_array($number, request()->query('review_score', []))): ?> checked <?php endif; ?> type="checkbox"
                                        name="review_score[]" value="<?php echo e($number); ?>">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Car/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>