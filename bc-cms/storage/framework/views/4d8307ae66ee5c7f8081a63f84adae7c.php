...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title"><?php echo e(__('Subscription Settings')); ?></h3>
        <p class="form-group-desc"><?php echo e(__('Control how vendor subscription plans are enforced on this platform.')); ?></p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <label>
                        <input type="checkbox" name="vendor_subscription_enabled" value="1"
                            <?php if(setting_item('vendor_subscription_enabled') == 1): ?> checked <?php endif; ?>>
                        <?php echo e(__("Require vendors to have an active subscription plan?")); ?>

                    </label>
                    <p><i><?php echo e(__('When enabled, vendors without an active plan will be redirected and cannot manage listings.')); ?></i></p>
                </div>
                <div class="form-group" data-condition="vendor_subscription_enabled:is(1)">
                    <label><?php echo e(__('Grace Period (days after expiry)')); ?></label>
                    <div class="form-controls">
                        <input type="number" class="form-control" name="vendor_subscription_grace_period"
                            value="<?php echo e(setting_item('vendor_subscription_grace_period', 0)); ?>"
                            min="0" max="90" style="width:120px">
                    </div>
                    <p><i><?php echo e(__('Vendors retain access for this many days after their subscription expires. Set 0 for immediate lockout.')); ?></i></p>
                </div>
                <div class="form-group" data-condition="vendor_subscription_enabled:is(1)">
                    <label><?php echo e(__('Redirect expired vendors to (URL or route)')); ?></label>
                    <div class="form-controls">
                        <input type="text" class="form-control" name="vendor_subscription_expired_redirect"
                            value="<?php echo e(setting_item('vendor_subscription_expired_redirect')); ?>"
                            placeholder="<?php echo e(__('e.g. /vendor/subscription or leave blank for dashboard')); ?>">
                    </div>
                </div>
                <div class="form-group mt-3">
                    <a href="<?php echo e(route('vendor.admin.plan.index')); ?>" class="btn btn-info btn-sm">
                        <i class="fa fa-list"></i> <?php echo e(__('Manage Plans')); ?>

                    </a>
                    <a href="<?php echo e(route('vendor.admin.subscription.index')); ?>" class="btn btn-secondary btn-sm ml-2">
                        <i class="fa fa-users"></i> <?php echo e(__('View All Subscriptions')); ?>
...
<?php endif; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Vendor/Views/admin/settings/vendor.blade.php ENDPATH**/ ?>