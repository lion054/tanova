                ...
                <?php if($row->getGallery()): ?>
                    <div class="relative d-flex justify-center overflow-hidden js-section-slider"
                        ...
                        <div class="swiper-wrapper">
                            <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="swiper-slide">
                                    <img src="<?php echo e($item['large']); ?>" alt="<?php echo e(__('Gallery')); ?>"
                        ...
                        <div class="absolute h-full col-12 z-2 px-20 py-20 d-flex justify-end items-end gotrip-banner">
                            <div class="btn-group">
                                <?php if($row->video): ?>
                                    <a href="#" class="btn btn-transparent has-icon bc-video-popup"
                                        data-toggle="modal" data-src="<?php echo e(handleVideoUrl($row->video)); ?>"
                                        data-target="#myModal">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="text-15 lh-15">
                                    ...
                                    <?php if($row->max_people > 1): ?>
                                        <?php echo e(__(':number persons', ['number' => $row->max_people])); ?>

                                    <?php else: ?>
                                        <?php echo e(__(':number person', ['number' => $row->max_people])); ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Tour/Views/frontend/layouts/details/tour-detail.blade.php ENDPATH**/ ?>