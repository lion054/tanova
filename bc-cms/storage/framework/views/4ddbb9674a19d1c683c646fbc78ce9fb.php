...
<?php if(!empty($services) and $services->total()): ?>
    <div class="bc-profile-list-services">
        <?php echo $__env->make('Tour::frontend.blocks.list-tour.index', ['rows'=>$services,'style_list'=> 'normal','title'=>!empty($view_all) ? __('Tour by :name',['name'=>$user->first_name]) : '','col'=>4], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Tour/Views/frontend/profile/service.blade.php ENDPATH**/ ?>