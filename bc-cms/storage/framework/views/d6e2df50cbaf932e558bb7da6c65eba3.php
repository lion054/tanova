    ...
    <div class="booking-review-content">
        ...
        <div class="review-section">
            <ul class="review-list">
                <?php if($pick_up = $booking->getMeta('pick_up') ): ?>
                    <li>
                        <div class="label"><?php echo e(__('Pick up:')); ?></div>
                        <div class="val">
                            <?php echo e($pick_up); ?>
                ...
                <?php endif; ?>
                <?php if($drop_off = $booking->getMeta('drop_off') ): ?>
                    <li>
                        <div class="label"><?php echo e(__('Drop off:')); ?></div>
                        <div class="val">
                            <?php echo e($drop_off); ?>
            ...
            <div class="modal-body">
                <ul class="review-list list-unstyled">
                    <li class="mb-3 pb-1 border-bottom">
                        ...
                        <div>
                            <?php if ($__env->exists("Car::frontend.booking.detail-date",['rows'=>$dateDetail,'number'=>$booking->number])) echo $__env->make("Car::frontend.booking.detail-date",['rows'=>$dateDetail,'number'=>$booking->number], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Car/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>