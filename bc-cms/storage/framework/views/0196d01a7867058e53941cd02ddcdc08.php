...
<?php $__env->startSection('content'); ?>
    ...
    <section class="bc_search bc_search_hotel halfMap">
        <h1 class="d-none">
        ...
        <div class="halfMap__content">
            <div class="bc_form_search_map ">
                <div class="mainSearch bg-white pr-10 py-10 lg:px-20 lg:pt-5 lg:pb-20 bg-light-2 rounded-4">
                    <?php echo $__env->make('Hotel::frontend.layouts.search.form-search', ['style' => 'map'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
            <div class="bc_filter_search_map" id="advance_filters">
                <?php echo $__env->make('Hotel::frontend.layouts.search-map.filter-search-map', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            ...
            <div class="row y-gap-10 justify-between items-center pt-20">
                ...
                <div class="col-auto bc-form-order">
                    <?php echo $__env->make('Layout::global.search.orderby', [
                        'routeName' => 'hotel.search',
                        'hidden_map_button' => 1,
                    ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
            <div class="ajax-search-result">
                <?php echo $__env->make('Hotel::frontend.ajax.search-result-map', ['layout' => 'normal'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Hotel/Views/frontend/search-map.blade.php ENDPATH**/ ?>