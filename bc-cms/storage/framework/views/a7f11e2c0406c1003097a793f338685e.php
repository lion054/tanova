<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input type="text" value="<?php echo e(route('booking.admin.export-ical',['type'=>'property',$row->id])); ?>"   class="form-control">
        </div>
            <?php endif; ?>
    </div>
</div>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Property/Views/admin/property/ical.blade.php ENDPATH**/ ?>