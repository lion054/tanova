...
<div class="container-fluid">
    ...
    <nav class="mb-3"><ol class="breadcrumb small mb-0">
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.tanova.index')); ?>">Tanova</a></li>
        <li class="breadcrumb-item active"><?php echo e(Str::limit($trip->title, 40)); ?></li>
    </ol></nav>

    <div class="d-flex justify-content-between align-items-start mb-4 flex-wrap gap-3">
        <div>
            <p class="portal-eyebrow">Tanova Itinerary</p>
            <h1 class="portal-h1"><?php echo e($trip->title); ?></h1>
            <div style="display:flex;align-items:center;gap:8px;margin-top:6px;flex-wrap:wrap">
                ...
                <?php endif; ?>
                <span style="font-size:12px;color:#aaa">Generated <?php echo e($trip->created_at?->diffForHumans()); ?></span>
            </div>
        </div>
        <a href="<?php echo e(route('admin.tanova.index')); ?>" class="tp-ab-btn tp-ab-btn--ghost">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-8">
            ...
            <div class="tn-pkg-tabs" id="tn-tabs">
                ...
                <button class="tn-pkg-tab <?php echo e($loop->first ? 'active' : ''); ?>"
                        data-pkg="<?php echo e($pkg['package']); ?>">
                    Package <?php echo e($pkg['package']); ?>

                    <span class="cost">USD <?php echo e(number_format($pkg['total_cost'] ?? 0, 0)); ?></span>
                </button>
            ...
            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="tn-pkg-pane <?php echo e($loop->first ? 'active' : ''); ?>" id="pkg-<?php echo e($pkg['package']); ?>">

                
                <?php if(!empty($pkg['hotel'])): ?>
                <div style="display:flex;align-items:center;gap:10px;padding:10px 16px;background:#fafafa;border:1px solid #ebebeb;border-radius:8px;margin-bottom:16px;font-size:12px;">
                    ...
                    <span style="font-weight:600;color:#0a0a0a"><?php echo e($pkg['hotel']['name']); ?></span>
                    <span style="color:#aaa">· <?php echo e($pkg['hotel']['type'] ?? ''); ?></span>
                    <span style="color:#aaa">· <?php echo e($pkg['hotel']['rooms'] ?? 1); ?> room(s) @ USD <?php echo e(number_format($pkg['hotel']['cost_per_night'] ?? 0, 0)); ?>/night</span>
                    <span style="margin-left:auto;font-weight:700;color:#0a0a0a">Stay: USD <?php echo e(number_format($pkg['stay_cost'] ?? 0, 0)); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="tp-card">
                    <div class="tp-card-header">
                        ...
                        Itinerary — <?php echo e($trip->nightCount()); ?> nights
                        <span style="margin-left:auto;font-size:12px;color:#aaa;font-weight:400" id="act-cost-<?php echo e($pkg['package']); ?>">
                            Activities: USD <?php echo e(number_format($pkg['activity_cost'] ?? 0, 0)); ?>

                        </span>
                    </div>
                    <div class="tp-card-body">
                        <?php $__empty_1 = true; $__currentLoopData = $pkg['itinerary'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="tn-day">
                            <div class="tn-day-header">
                                <div class="tn-day-num"><?php echo e($day['day']); ?></div>
                                <div>
                                    <div class="tn-day-title"><?php echo e($day['title'] ?? 'Day '.$day['day']); ?></div>
                                    <?php if(!empty($day['date'])): ?><div class="tn-day-date"><?php echo e($day['date']); ?></div><?php endif; ?>
                                    <?php if(!empty($day['weather'])): ?>
                                    <div class="tn-day-weather">
                                        <?php echo e($day['weather']['icon'] ?? ''); ?>

                                        <?php echo e($day['weather']['temp_min'] ?? '?'); ?>–<?php echo e($day['weather']['temp_max'] ?? '?'); ?>°C
                                        <span style="color:#aaa;margin-left:2px">· <?php echo e(str_replace('_', ' ', $day['weather']['condition'] ?? '')); ?></span>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="tn-day-activities" id="day-acts-<?php echo e($pkg['package']); ?>-<?php echo e($day['day']); ?>">
                            ...
                            <div class="tn-stay">
                                ...
                                <?php echo e($day['accommodation']['name'] ?? ''); ?>

                                <?php if(!empty($day['accommodation']['type'])): ?> · <?php echo e($day['accommodation']['type']); ?> <?php endif; ?>
                            </div>
                            <?php endif; ?>

                            <?php if(!empty($day['meals'])): ?>
                            <div class="tn-meals">
                                <?php if($day['meals']['breakfast'] ?? false): ?><span class="tn-meal" title="Own expense — not included in package">Breakfast ⁽*⁾</span><?php endif; ?>
                                <?php if($day['meals']['lunch']     ?? false): ?><span class="tn-meal">Lunch</span><?php endif; ?>
                                <?php if($day['meals']['dinner']    ?? false): ?><span class="tn-meal" title="Own expense — not included in package">Dinner ⁽*⁾</span><?php endif; ?>
                            </div>
                            <?php endif; ?>
                            ...
                            <button class="tn-add-act-btn"
                                    data-pkg="<?php echo e($pkg['package']); ?>"
                                    data-day="<?php echo e($day['day']); ?>">
                                <i class="ion ion-ios-add-circle"></i> Add Activity to Day <?php echo e($day['day']); ?>

                            </button>
                            <?php endif; ?>

                            <?php if(!$loop->last): ?><hr style="margin:16px 0;border-color:#f0f0f0"><?php endif; ?>
                        </div>
            ...
            <div class="tp-card" style="margin-bottom:14px">
                <div class="tp-card-body" style="text-align:center;padding:20px">
                    ...
                    <div class="price-pill" id="tn-price-display">
                        <?php echo e(number_format($packages[0]['total_cost'] ?? $trip->estimated_price ?? 0, 0)); ?>
                    ...
                    <div style="font-size:12px;color:#aaa;margin-top:8px">
                        ...
                        ?>
                        USD <?php echo e(number_format($ppp, 0)); ?> per person
                        </span>
                        · <?php echo e($trip->guests); ?> guests · <?php echo e($trip->nightCount()); ?> nights
                    </div>
                </div>
            </div>
            ...
            <div class="tp-card" style="margin-bottom:14px">
                ...
                <div class="tp-card-body" style="padding:16px 20px">
                    ...
                    <table class="tn-summary">
                        <?php if($displayName): ?>
                        <tr><td>Guest</td><td style="font-weight:600"><?php echo e($displayName); ?></td></tr>
                        <?php endif; ?>
                        <?php if($displayEmail): ?>
                        <tr><td>Email</td><td><a href="mailto:<?php echo e($displayEmail); ?>" style="color:#2563eb;text-decoration:none"><?php echo e($displayEmail); ?></a></td></tr>
                        <?php endif; ?>
                        <?php if($displayPhone): ?>
                        <tr><td>Phone</td><td><a href="tel:<?php echo e($displayPhone); ?>" style="color:#0a0a0a;text-decoration:none"><?php echo e($displayPhone); ?></a></td></tr>
                        <?php endif; ?>
                        <tr><td>Destination</td><td><?php echo e($trip->destination); ?></td></tr>
                        <tr><td>Dates</td><td><?php echo e($trip->start_date?->format('d M Y')); ?> → <?php echo e($trip->end_date?->format('d M Y')); ?></td></tr>
                        <tr><td>Nights</td><td><?php echo e($trip->nightCount()); ?></td></tr>
                        <tr><td>Guests</td><td><?php echo e($trip->guests); ?></td></tr>
                        <tr><td>Packages</td><td><?php echo e(count($packages)); ?></td></tr>
                        <tr><td>Package</td><td style="font-weight:700" id="tn-summary-pkg">
                            <?php if($trip->booked_package): ?> Package <?php echo e($trip->booked_package); ?> <?php else: ?> Package 1 <?php endif; ?>
                        </td></tr>
                        <tr><td>Status</td><td>
                            <?php if($trip->status === 'created'): ?>
                                <span class="tp-badge tp-badge--amber">Awaiting Action</span>
                        ...
                        <?php if($trip->booking_id): ?>
                        <tr><td>Booking</td><td>
                            <a href="<?php echo e(route('booking.admin.edit', ['id' => $trip->booking_id])); ?>" style="color:#2563eb;font-weight:600">#<?php echo e($trip->booking_id); ?></a>
                        </td></tr>
                        <?php endif; ?>
                    </table>
                    ...
                    <?php if($existingInvoice): ?>
                        <a href="<?php echo e(route('tourpay.vendor.edit', $existingInvoice->id)); ?>"
                           style="display:inline-flex;align-items:center;gap:6px;margin-top:14px;padding:8px 14px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;font-size:12px;font-weight:600;color:#16a34a;text-decoration:none">
                            ...
                            View Invoice <?php echo e($existingInvoice->invoice_number); ?>

                        </a>
                    <?php else: ?>
                        <form method="POST" action="<?php echo e(route('admin.tanova.createInvoice', $trip)); ?>" style="margin-top:14px">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="package" id="tn-invoice-pkg"
                                   value="<?php echo e($trip->booked_package ?? 1); ?>">
                            <button type="submit"
                ...
                <div class="tp-card-body" style="padding:16px 20px">
                    <div style="display:flex;align-items:center;gap:10px;background:#f8f9fa;border:1px solid #ebebeb;border-radius:8px;padding:10px 14px;margin-bottom:14px">
                        ...
                        <div>
                            ...
                            <div style="font-size:13px;font-weight:700;color:#0a0a0a" id="tn-sel-label">Package 1 — USD <?php echo e(number_format($packages[0]['total_cost'] ?? 0, 0)); ?></div>
                        </div>
                    </div>
                    ...
                    <select id="tn-book-pkg" style="display:none">
                        <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($pkg['package']); ?>">Package <?php echo e($pkg['package']); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div id="tn-modal-overlay" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.45);z-index:9999;align-items:center;justify-content:center">
                <div style="background:#fff;border-radius:12px;width:100%;max-width:460px;margin:20px;box-shadow:0 24px 64px rgba(0,0,0,.18);overflow:hidden">
                    ...
                    <div style="padding:20px 22px">
                        <form method="POST" action="<?php echo e(route('admin.tanova.move', $trip)); ?>" id="tn-book-form">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="tp-field">
                                        ...
                                        <?php $guestParts = explode(' ', $trip->guest_name ?? $trip->user?->name ?? '', 2); ?>
                                        <input type="text" name="first_name" id="tn-first" required
                                               value="<?php echo e($trip->user?->first_name ?? $guestParts[0] ?? ''); ?>"
                                ...
                                <div class="col-6">
                                    <div class="tp-field">
                                        ...
                                        <input type="text" name="last_name" id="tn-last"
                                               value="<?php echo e($trip->user?->last_name ?? ($guestParts[1] ?? '')); ?>"
                            ...
                            <div class="tp-field">
                                ...
                                <input type="email" name="email" id="tn-email" required
                                       value="<?php echo e($trip->guest_email ?? $trip->user?->email ?? ''); ?>"
                                       placeholder="guest@example.com">
                            </div>
                            <div class="tp-field">
                                <label>Phone</label>
                                <input type="text" name="phone" id="tn-phone"
                                       value="<?php echo e($trip->guest_phone ?? $trip->user?->phone ?? ''); ?>"
        ...
        <div style="padding:14px 22px;border-top:1px solid #f0f0f0;background:#fafafa;flex-shrink:0">
            <div style="display:flex;gap:12px;align-items:flex-end">
                ...
                <div style="width:80px">
                    ...
                    <input type="number" id="tn-add-pax" min="1" max="50" value="<?php echo e($trip->guests); ?>"
...
(function(){
    // ── State ─────────────────────────────────────────────────────────────────
    var pkgState  = <?php echo json_encode(collect($packages)->keyBy('package')->toArray(), 15, 512) ?>;
    var guests    = <?php echo e((int) $trip->guests); ?>;
    var activePkg = 1;
    var dirty     = false;
    var canEdit   = <?php echo e($canEdit ? 'true' : 'false'); ?>;

    var saveUrlTpl  = '<?php echo e(route('admin.tanova.savePackage', [$trip, '__PKG__'])); ?>';
    var searchUrl   = '<?php echo e(route('admin.tanova.activities', $trip)); ?>';
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/pro/Tanova/Views/admin/detail.blade.php ENDPATH**/ ?>