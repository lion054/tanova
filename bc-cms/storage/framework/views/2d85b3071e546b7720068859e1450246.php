    ...
    <div class="row y-gap-10 justify-between items-center pb-20 topbar-search">
        ...
        <div class="col-auto">
            <div class="control d-flex align-items-center">
                <?php echo $__env->make('Hotel::frontend.layouts.search-map.orderby', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Hotel/Views/frontend/layouts/search-map/list-item.blade.php ENDPATH**/ ?>