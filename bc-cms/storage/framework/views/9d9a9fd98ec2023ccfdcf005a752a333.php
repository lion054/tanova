...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4 flex-wrap gap-3">
        ...
        <a href="<?php echo e(route('admin.integrations.category', 'stay_os')); ?>" class="tp-ab-btn tp-ab-btn--ghost"
    ...
    <div style="text-align:center;padding:72px 24px;background:#fff;border:1px solid #ebebeb;border-radius:10px">
        ...
        <a href="<?php echo e(route('admin.integrations.category', 'stay_os')); ?>"
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/pro/Integrations/Views/admin/catalog.blade.php ENDPATH**/ ?>