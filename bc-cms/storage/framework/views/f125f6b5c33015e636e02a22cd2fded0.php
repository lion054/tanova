...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        const loadDateRoute = '<?php echo e($hotel ? route('hotel.vendor.room.availability.loadDates', ['hotel_id' => $hotel->id]) : route('hotel.vendor.availability.loadDates')); ?>';
        const storeDateRoute = '<?php echo e($hotel ? route('hotel.vendor.room.availability.store', ['hotel_id' => $hotel->id]) : route('hotel.vendor.availability.store')); ?>';
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Hotel/Views/frontend/user/availability.blade.php ENDPATH**/ ?>