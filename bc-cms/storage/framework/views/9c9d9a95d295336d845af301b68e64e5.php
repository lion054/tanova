<div class="bc_filter sidebar">
    <?php if($layout == 'grid_2'): ?>
        <div class="g-filter-item sidebar__item -no-border bc-form-search">
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('hotel.search')); ?>" class="bc_form_filter lg:d-none" data-x="filterPopup"
        ...
        <aside class="sidebar y-gap-40 p-4 p-lg-0">
            ...
            <div class="g-filter-item sidebar__item -no-border">
                <div class="flex-center ratio ratio-15:9 js-lazy"
                    data-bg="<?php echo e(get_file_url(setting_item('hotel_map_image'), 'full')); ?>">
                    <a href="<?php echo e(route('hotel.search', ['_layout' => 'map'])); ?>"
                            ...
                            <div class="col-auto">
                                <div class="d-flex items-center">
                                    <div class="form-checkbox ">
                                        <input type="checkbox" name="star_rate[]"
                                            <?php if(in_array($number, request()->query('star_rate', []))): ?> checked <?php endif; ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Hotel/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>