<div class="searchMenu-date px-30 lg:py-20 lg:px-0 form-date-search-hotel position-relative">
    <div class="date-wrapper" data-x-dd-click="searchMenu-date">
        <h4 class="text-15 fw-500 ls-2 lh-16"><?php echo e(__(('Check in - Check out'))); ?></h4>
    </div>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Event/Views/frontend/layouts/search-map/fields/date.blade.php ENDPATH**/ ?>