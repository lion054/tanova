...
<?php if(!empty($types)): ?>
    ...
    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $moduleClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            ...
            $services = $moduleInst
                ...
                ->join('bc_locations', function ($join) use ($row, $moduleInst) {
                    $join
                        ->on('bc_locations.id', '=', $moduleInst::getTableName() . '.location_id')
        ...
        <?php if($services->count() > 0): ?>
            <section class="layout-pt-md layout-pb-md bc-location-service-list">
                <div class="row y-gap-20 justify-between items-end">
                    <div class="col-auto">
                        <div class="sectionTitle -md">
                            <h2 class="sectionTitle__title"><?php echo e(__('Most Popular :name', ['name' => call_user_func([$moduleClass, 'getModelName'])])); ?>
                    ...
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xl-3 col-lg-3 col-sm-6 loop-type-<?php echo e($type); ?>">
                            ...
                            <?php if(view()->exists($view)): ?>
                                <?php echo $__env->make($view, ['row' => $service], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Location/Views/frontend/layouts/details/location-service.blade.php ENDPATH**/ ?>