<tr>
    ...
    <td width="2%">
        ...
        <?php if(!empty(setting_item("visa_allow_vendor_can_change_their_booking_status"))): ?>
            ...
            <div class="dropdown-menu">
                <?php if(!empty($statues)): ?>
                    <?php $__currentLoopData = $statues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route("visa.vendor.booking_report.bulk_edit" , ['id'=>$booking->id , 'status'=>$status])); ?>">
        ...
        <?php endif; ?>
        <?php if(!empty(setting_item("visa_allow_vendor_can_change_paid_amount"))): ?>
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('visa.user.booking-detail',['code'=>$booking->code,'source'=>'report'])); ?>" class="btn btn-xs btn-primary mt-1 btn-info-booking px-1 d-inline-flex align-items-center" style="width: auto">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Visa/Views/frontend/bookingReport/loop.blade.php ENDPATH**/ ?>