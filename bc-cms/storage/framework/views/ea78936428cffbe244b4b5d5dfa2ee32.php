...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__('Courses Availability Calendar')); ?></h1>
        </div>
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab', function(e) {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: {
                    url: "<?php echo e(route('course.admin.availability.loadDates')); ?>",
                    extraParams: {
                        id: lastId,
                    }
                },
        ...
        const formModalApp = window.vueCreateApp({
            ...
            methods: {
                ...
                saveForm: function() {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('course.admin.availability.store')); ?>',
                        data: this.form,
                        dataType: 'json',
                        method: 'post',
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Course/Views/admin/availability.blade.php ENDPATH**/ ?>