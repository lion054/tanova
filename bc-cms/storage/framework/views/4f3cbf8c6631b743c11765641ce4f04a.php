        ...
        <div class="col-md-<?php echo e($value_col_size ?? 4); ?> btn-upload-private-wrap">
            <div class="private-file-lists mb-2">
                ...
                <?php if(!empty($old)): ?>
                    ...
                    <a target="_blank" href="<?php echo e(route('media.private.view',['code'=>$old['code'] ?? '','v'=>uniqid()])); ?>" class="file-item"><?php echo e($old['name']); ?> <i class="fa fa-download"></i></a>
                <?php endif; ?>
            </div>
            <?php if(empty($only_show_data)): ?>
                <span class="btn btn-primary btn-sm "><i class="fa fa-upload"></i> <?php echo e(__('Select File')); ?>

                    <input class="btn-upload-private-file" data-name="verify_data_<?php echo e($field['id']); ?>"  data-multiple="" type="file" accept="<?php echo e(implode(',', $config['mime'])); ?>" >
                </span>
            <?php else: ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/User/Views/frontend/verification/fields/file.blade.php ENDPATH**/ ?>