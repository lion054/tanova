...
<?php $__env->startSection('content'); ?>
    <div class="row y-gap-20 justify-between items-end pb-20 lg:pb-40 md:pb-20">
        <div class="col-auto">
            <h1 class="text-30 lh-14 fw-600"><?php echo e($row->id ? __('Edit: ') . $row->title : __('Add new boat')); ?></h1>
            <div class="text-15 text-light-1"><?php echo e(__('AI-native boat and charter management. Fleet availability, bookings, and dispatch.')); ?></div>
        </div>
    ...
    <div class="lang-content-box">
        <form action="<?php echo e(route('boat.vendor.store', ['id' => $row->id ? $row->id : '-1', 'lang' => request()->query('lang')])); ?>"
            method="post">
            <?php echo csrf_field(); ?>
            <div class="form-add-service">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-tour-content">
                        <?php echo $__env->make('Boat::admin/boat/content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php if(is_default_lang()): ?>
                    ...
                    <div class="tab-pane fade" id="nav-tour-location">
                        <?php echo $__env->make('Boat::admin/boat/location', ['is_smart_search' => '1'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <div class="tab-pane fade" id="nav-tour-pricing">
                        ...
                        <?php echo $__env->make('Boat::admin/boat/pricing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <?php if(is_default_lang()): ?>
                        <div class="tab-pane fade" id="nav-attribute">
                            <?php echo $__env->make('Boat::admin/boat/attributes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
    ...
    <script>
        jQuery(function($) {
            new BCMapEngine('map_content', {
                fitBounds: true,
                center: [<?php echo e($row->map_lat ?? setting_item('map_lat_default', '0')); ?>,
                    <?php echo e($row->map_lng ?? setting_item('map_lng_default', '0')); ?>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Boat/Views/frontend/manageBoat/detail.blade.php ENDPATH**/ ?>