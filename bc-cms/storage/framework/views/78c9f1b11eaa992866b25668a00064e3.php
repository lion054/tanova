        ...
        <div class="row y-gap-30 justify-between items-center">
            ...
            <div class="col-auto">
                <form action="<?php echo e(route('newsletter.subscribe')); ?>"
                    class="subcribe-form bc-subscribe-form bc-form single-field -w-410 d-flex x-gap-10 y-gap-20">
                    <?php echo csrf_field(); ?>
                    <div>
...
<?php echo $__env->make('Layout::parts.footer-style.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php if(setting_item('cookie_agreement_type') == 'cookie_agreement' and
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Layout/parts/footer.blade.php ENDPATH**/ ?>