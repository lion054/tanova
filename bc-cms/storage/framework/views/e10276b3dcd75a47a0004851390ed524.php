...
<?php $__env->startSection('content'); ?>
    ...
    >
        ...
        <div
            ...
            v-bind:class="message.type ? 'alert-success' : 'alert-danger'"
        >{{message.content}}
        </div>
        <input
            type="text"
            ...
            v-model="title"
            placeholder="<?php echo e(__('Template Name')); ?>"
        >
        <br>
        <br>
        <div class="row">
                ...
                <div class="">
                    <div class="panel-body">
                        <input
                            ...
                            value=""
                            v-model="s"
                            placeholder="<?php echo e(__('Search for block...')); ?>"
                        >
                        <hr>
                        <div
                            :key="index"
                        ...
                        >
                            ...
                            >{{block.name}}
                                <div class="cursor-pointer"><i
                                        class="fa"
                                        v-bind:class="{'fa-minus':block.open,'fa-plus':!block.open}"
                                    ></i></div>
                            </div>
                            <div
                                v-show="block.open"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Template/Views/admin/detail.blade.php ENDPATH**/ ?>