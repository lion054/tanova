...
<?php if($available_payout_amount): ?>
    ...
    <br>
    <div class="">
        <a href="#vendor_create_request" data-bs-toggle="modal" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> <?php echo e(__("Create request")); ?></a>
    </div>
<?php else: ?>
    <div class="alert alert-warning"><?php echo e(__("Your balance is zero")); ?></div>
<?php endif; ?>

<div class="modal bc-form" tabindex="-1" role="dialog" id="vendor_create_request">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Vendor/Views/frontend/payouts/request.blade.php ENDPATH**/ ?>