    ...
    <div class="bc-how-it-works" style="background-image: linear-gradient(0deg,rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('<?php echo e(get_file_url($background_image ?? "","full")); ?>') !important">
        <?php if($list_item): ?>
        <div class="container">
            <div class="title">
                <?php echo e($title); ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Template/Views/frontend/blocks/how-it-work/index.blade.php ENDPATH**/ ?>