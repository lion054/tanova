...
<?php $__env->startSection('content'); ?>
    <div class="bc_search bc_search_hotel">
        <?php if($layout != 'map'): ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php echo $__env->make('Hotel::frontend.layouts.search.form-search', ['style' => 'default'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <?php echo $__env->make('Hotel::frontend.layouts.search.list-item', ['layout' => $layout], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Hotel/Views/frontend/search.blade.php ENDPATH**/ ?>