    ...
    <div class="panel-body">
        ...
        <?php if(is_default_lang()): ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label><?php echo e(__("Hotel Phone")); ?></label>
                        <input type="text" value="<?php echo e($row->phone); ?>" placeholder="<?php echo e(__("Eg: +84 123456789")); ?>" name="phone" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label><?php echo e(__("Hotel Website")); ?></label>
                        <input type="text" value="<?php echo e($row->website); ?>" placeholder="<?php echo e(__("https://bookingcore.co")); ?>" name="website" class="form-control">
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Hotel/Views/admin/hotel/content.blade.php ENDPATH**/ ?>