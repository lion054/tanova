...
<head>
    <meta charset="UTF-8"/>
    <title>Booking Core - Laravel Booking System</title>
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a target="_blank" href="<?php echo e(config('landing.item_url')); ?>" class="dropdown-item btn-buynow">BUY NOW</a>
                        </div>
                    </div>
                    <ul class="menu">
                        <li>
            ...
            <div class="demo-tab-wrapper">
                <?php $__currentLoopData = config('landing.list_demo'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="modern-layout item-tab active">
                        <?php echo $__env->make('landing.view.item', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/resources/views/landing/index.blade.php ENDPATH**/ ?>