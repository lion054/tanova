        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo e(route('course.admin.attribute.term.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(route('course.admin.attribute.term.editTermBulk')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                                ...
                                <?php if(count($rows) > 0): ?>
                                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="title">
                                                <a href="<?php echo e(route('course.admin.attribute.term.edit',['id'=>$row->id])); ?>"><?php echo e($row->name); ?></a>
                                            </td>
                                            <td><?php echo e(display_date($row->updated_at)); ?></td>
                                            <td><a class="btn btn-primary btn-sm" href="<?php echo e(route('course.admin.attribute.term.edit',['id'=>$row->id])); ?>"><i class="fa fa-edit"></i> <?php echo e(__('Edit')); ?></a></td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Course/Views/admin/terms/index.blade.php ENDPATH**/ ?>