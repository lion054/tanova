...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('car.admin.store', ['id' => $row->id ? $row->id : '-1', 'lang' => request()->query('lang')])); ?>"
        method="post">
        <?php echo csrf_field(); ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    <?php if($row->slug): ?>
                        <p class="item-url-demo"><?php echo e(__('Permalink')); ?>: <?php echo e(url('car')); ?>/<a href="#"
                ...
                <div class="">
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>"
                            target="_blank"><?php echo e(__('View Car')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <?php echo $__env->make('Car::admin.car.location', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Car/Views/admin/detail.blade.php ENDPATH**/ ?>