...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Lessons Management")); ?></h1>
        </div>
                            ...
                            <div class="col-sm-4 d-flex justify-content-end align-items-center">
                                <div class="btn-group">
                                    <button class="btn btn-outline-primary dropdown-toggle btn-sm ml-1" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-plus"></i> <?php echo e(__("Add lecture")); ?>

                                    </button>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <a href="#" class="dropdown-item" @click.prevent="addLecture('video',row)"><i class="fa fa-play-circle-o"></i> <?php echo e(__("Add video")); ?></a>
                                        <a href="#" class="dropdown-item" @click.prevent="addLecture('presentation',row)"><i class="fa fa-file-powerpoint-o"></i> <?php echo e(__("Add presentation")); ?></a>
                                        <a href="#" class="dropdown-item" @click.prevent="addLecture('iframe',row)"><i class="fa fa-desktop"></i> <?php echo e(__("Add Iframe")); ?></a>
                                        <a href="#" class="dropdown-item" @click.prevent="addLecture('scorm',row)"><i class="fa fa-bookmark"></i> <?php echo e(__("Add SCORM")); ?></a>
                                    </div>
                                </div>
                                ...
                                <div class="d-inline-flex">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <a href="#" class="dropdown-item" @click.prevent="openSectionForm($event,row)"><i class="fa fa-edit"></i> <?php echo e(__("Edit section")); ?></a>
                                        <a href="#" class="dropdown-item" @click.prevent="deleteSection(row)"><i class="fa fa-trash"></i> <?php echo e(__("Remove section")); ?></a>
                                    </div>
                                </div>
                            ...
                            <div class="form-group-item">
                                <div class="g-items-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2"><?php echo e(__("Type")); ?></div>
                                        <div class="col-md-2"><?php echo e(__("Duration")); ?></div>
                                        <div class="col-md-1"><?php echo e(__("Order")); ?></div>
                                        <div class="col-md-2"></div>
                                    </div>
                                </div>
                                <div class="g-items">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">
                                        ...
                                        <span v-else><?php echo e(__("Edit Lecture")); ?></span>
                                    </h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label><?php echo e(__("Lecture name")); ?> <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group" >
                                        <label><?php echo e(__("File URL")); ?></label>
                                        <input type="text"  class="form-control" v-model="lecture_form.url">
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo e(__("Duration (minute)")); ?> <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" placeholder="<?php echo e(__("in minutes")); ?>" v-model="lecture_form.duration">
                                    </div>
                                    <div class="form-group" >
                                        <label><?php echo e(__("Preview Url")); ?></label>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" @click="saveLecture"><?php echo e(__("Save changes")); ?>
                    ...
                    <div id="add_section_modal" class="modal" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">
                                        <span v-if="!section_form.id"><?php echo e(__("Add Section")); ?></span>
                                        <span v-else><?php echo e(__("Edit Section")); ?></span>
                                    </h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label><?php echo e(__("Section name")); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo e(__('Close')); ?></button>
                                    <button type="button" class="btn btn-primary" @click="saveSection"><?php echo e(__("Save changes")); ?>
        ...
        <script>
            var course_sections_data = <?php echo json_encode($row->admin_js_data); ?>;
        </script>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Course/Views/admin/lectures/index.blade.php ENDPATH**/ ?>