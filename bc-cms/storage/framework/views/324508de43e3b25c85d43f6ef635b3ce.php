            ...
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo e(route('support.admin.ticket.category.store',['id'=>-1])); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <?php echo $__env->make('Support::admin/ticket/category/form',['parents'=>$rows], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <div class="">
                ...
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form
                                method="post"
                                action="<?php echo e(route('support.admin.ticket.category.bulkEdit')); ?>"
                    ...
                    <div class="col-left">
                        <form
                            method="get"
                            action="<?php echo e(route('support.admin.ticket.category.index')); ?> "
                        ...
                        <form action="" class="bc-form-item">
                            <table class="table table-hover">
                                ...
                                <?php if(count($rows) > 0): ?>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="ids[]" value="<?php echo e($row->id); ?>" class="check-item">
                                        </td>
                                        <td class="title">
                                            <a href="<?php echo e(route('support.admin.ticket.category.edit',['id'=>$row->id])); ?>"><?php echo e($prefix.' '.$row->name); ?></a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a
                                                class="btn btn-sm btn-default" href="<?php echo e(route('support.admin.ticket.category.edit',['id'=>$row->id])); ?>"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/pro/Support/Views/admin/ticket/category/index.blade.php ENDPATH**/ ?>