<div class="panel" id="VisaFormBuider" v-cloak>
    <div class="panel-title"><strong><?php echo e(__("Form Builder")); ?></strong></div>
    <div class="panel-body">
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-sm btn-default" v-on:click.prevent="addNode('ROOT')"><?php echo e(__("Add field")); ?></a>
        </div>
    </div>
</div>
    ...
    <div class="form-node">
        ...
        <template v-if="node.type === 'section'">
            <div class="form-node type-section">
                ...
                <div class="d-flex justify-content-end">
                    <a class="btn btn-sm btn-default" v-on:click.prevent="addNode"><?php echo e(__("Add field")); ?></a>
                </div>
            </div>
        </template>
    </div>
</template><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Visa/Views/admin/visa/form-builder.blade.php ENDPATH**/ ?>