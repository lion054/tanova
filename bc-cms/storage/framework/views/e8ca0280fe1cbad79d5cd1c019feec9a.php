                                    ...
                                    <?php if($booking->status !='draft'): ?>
                                        ...
                                        <?php if($booking->paid < $booking->total ): ?>
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="val d-flex align-items-center">
                                                    <?php echo e(currency_symbol()); ?>

                                                    <input class="text-right form-control ml-1" 
                                                    type="number" 
                                                    min="0" 
                                                    max="<?php echo e($booking->total); ?>" 
                                                    id="set_paid_input" 
                                                    value="<?php echo e(($booking->total - $booking->paid)); ?>" />
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    <?php endif; ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Layout/global/booking/set-paid-modal.blade.php ENDPATH**/ ?>