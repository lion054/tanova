...
<?php echo $__env->make('Hotel::frontend.layouts.details.hotel-room-list', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<div class="form-send-enquiry mt-3 pt-3 mb-3" v-show="enquiry_type=='enquiry'">
    <button class="button -dark-1 py-15 px-35 h-60 col-12 col-lg-4 rounded-4 bg-blue-1 text-white cursor-pointer btn-primary" data-toggle="modal" data-target="#enquiry_form_modal">
        <?php echo e(__("Contact Now")); ?>

    </button>
</div>
<?php echo $__env->make("Booking::frontend.global.enquiry-form",['service_type'=>'hotel'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Hotel/Views/frontend/layouts/details/hotel-rooms.blade.php ENDPATH**/ ?>