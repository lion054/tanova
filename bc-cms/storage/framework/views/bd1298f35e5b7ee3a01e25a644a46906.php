<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input type="text" value="<?php echo e(route('booking.admin.export-ical',['type'=>'hotel',$row->id])); ?>"   class="form-control">
        </div>
            <?php endif; ?>
    </div>
</div>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Hotel/Views/admin/hotel/ical.blade.php ENDPATH**/ ?>