                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo e(route('news.admin.tag.store',['id'=>-1])); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <?php echo $__env->make('News::admin/tag/form',['parents'=>$rows], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <div class="">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/News/Views/admin/tag/index.blade.php ENDPATH**/ ?>