    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" data-condition="facebook_enable:is(1)">
                    <label><?php echo e(__("Facebook Redirect")); ?></label>
                    <div class="form-controls">
                        <input type="text" readonly value="<?php echo e(url('/social-callback/facebook')); ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" data-condition="google_enable:is(1)">
                    <label><?php echo e(__("Google Redirect")); ?></label>
                    <div class="form-controls">
                        <input type="text" readonly value="<?php echo e(url('/social-callback/google')); ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        <div class="panel">
            <div class="panel-title"><strong><?php echo e(__('X')); ?></strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <label> <input type="checkbox" <?php if(setting_item('twitter_enable') == 1): ?> checked <?php endif; ?> name="twitter_enable" value="1"> <?php echo e(__("Enable X Login?")); ?></label>
                </div>
                <div class="form-group" data-condition="twitter_enable:is(1)">
                    <label><?php echo e(__("X Client Id")); ?></label>
                    <div class="form-controls">
                        <input type="text" name="twitter_client_id" value="<?php echo e(setting_item('twitter_client_id')); ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="twitter_enable:is(1)">
                    <label><?php echo e(__("X Client Secret")); ?></label>
                    <div class="form-controls">
                        <input type="text" name="twitter_client_secret" value="<?php echo e(setting_item('twitter_client_secret')); ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="twitter_enable:is(1)">
                    <label><?php echo e(__("X Redirect")); ?></label>
                    <div class="form-controls">
                        <input type="text" readonly value="<?php echo e(url('/social-callback/twitter')); ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        <div class="panel">
            <div class="panel-title"><strong><?php echo e(__('Apple')); ?></strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <label> <input type="checkbox" <?php if(setting_item('apple_enable') == 1): ?> checked <?php endif; ?> name="apple_enable" value="1"> <?php echo e(__("Enable Apple Login?")); ?></label>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label><?php echo e(__("Apple Client Id")); ?></label>
                    <div class="form-controls">
                        <input type="text" name="apple_client_id" value="<?php echo e(setting_item('apple_client_id')); ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label><?php echo e(__("Apple Key Id")); ?></label>
                    <div class="form-controls">
                        <input type="text" name="apple_key_id" value="<?php echo e(setting_item('apple_key_id')); ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label><?php echo e(__("Apple Team Id")); ?></label>
                    <div class="form-controls">
                        <input type="text" name="apple_team_id" value="<?php echo e(setting_item('apple_team_id')); ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label><?php echo e(__("Apple Private Key file name")); ?></label>
                    <div class="form-controls">
                        <input type="text" name="apple_private_key" value="<?php echo e(setting_item('apple_private_key')); ?>" class="form-control">
                    </div>
                    <p><strong><?php echo e(__("File name only")); ?></strong></p>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <div class="alert alert-warning">
                        <?php echo e(__("Please upload your apple private key at this folder: :path",['path'=>storage_path('app/')])); ?>

                    </div>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label><?php echo e(__("Apple Redirect")); ?></label>
                    <div class="form-controls">
                        <input type="text" readonly value="<?php echo e(url('/social-callback/apple')); ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <?php echo $__env->make('Core::admin.settings.groups.parts.cookie-consent-setting', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<hr>
<?php echo $__env->make('Core::admin.settings.groups.parts.pusher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Core/Views/admin/settings/groups/advance.blade.php ENDPATH**/ ?>