    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="address" id="customPlaceAddress" class="form-control"
                placeholder="<?php echo e(__('Real address')); ?>" value="<?php echo e($translation->address); ?>">
        </div>
        <?php if(is_default_lang()): ?>
            <div class="form-group">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Space/Views/admin/space/location.blade.php ENDPATH**/ ?>