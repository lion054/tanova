...
<div class="booking-review">
    ...
    <div class="booking-review-content">
        ...
        <div class="review-section total-review">
            <ul class="review-list">
                <?php $discount_by_days = $booking->getJsonMeta('discount_by_days')?>
                <?php if(!empty($discount_by_days)): ?>
                    <li>
                        <div class="label-title"><strong><?php echo e(__("Discounts:")); ?></strong></div>
                    </li>
                    <li class="no-flex">
                        <ul>
                            <?php $__currentLoopData = $discount_by_days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <div class="label">
                                        <?php if(!$type['to']): ?>
                                            <?php echo e(__('from :from',['from'=>$type['from']])); ?> <?php echo e(setting_item("space_booking_type",'by_day') == "by_day" ? __("day") : __("night")); ?>

                                        <?php else: ?>
                                            <?php echo e(__(':from - :to',['from'=>$type['from'],'to'=>$type['to']])); ?> <?php echo e(setting_item("space_booking_type",'by_day') == "by_day" ? __("day") : __("night")); ?>
                    ...
                    <ul class="review-list list-unstyled">
                            <li class="mb-3 pb-1 border-bottom">
                                <h6 class="label text-center font-weight-bold mb-1"></h6>
                                    <div>
                                        <?php if ($__env->exists("Space::frontend.booking.detail-date",['rows'=>$dateDetail])) echo $__env->make("Space::frontend.booking.detail-date",['rows'=>$dateDetail], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    </div>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Space/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>