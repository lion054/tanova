            ...
            ?>
                <?php if(view()->exists(ucfirst($type).'::frontend.profile.service') && $user->hasPermission($type.'_create')): ?>
                    <div class="tab-pane fade <?php if(!$i): ?> show active <?php endif; ?>" id="type_<?php echo e($type); ?>" role="tabpanel" aria-labelledby="pills-home-tab">
                        <?php echo $__env->make(ucfirst($type).'::frontend.profile.service',['services'=>$list_service[$type]], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <?php $i++; ?>
                <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/User/Views/frontend/profile/services.blade.php ENDPATH**/ ?>