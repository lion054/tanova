                        ...
                        <tr>
                            <td class="label">
                                ...
                                <?php if(!empty($buyer_fee['per_person']) and $buyer_fee['per_person'] == "on"): ?>
                                    : <?php echo e($booking->total_guests); ?> * <?php echo e(format_money( $buyer_fee['price'] )); ?>

                                <?php endif; ?>
                            </td>
                            <td class="val">
                                <?php if(!empty($buyer_fee['per_person']) and $buyer_fee['per_person'] == "on"): ?>
                                    <?php echo e(format_money( $buyer_fee['price'] * $booking->total_guests )); ?>

                                <?php else: ?>
                                    <?php echo e(format_money($buyer_fee['price'])); ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Course/Views/emails/new_booking_detail.blade.php ENDPATH**/ ?>