    ...
    <div class="panel-body">
                        ...
                        <div class="form-content">
                            ...
                            <div class="smart-search">
                                <input type="text" class="smart-search-location parent_text form-control"
                                    placeholder="<?php echo e(__('-- Please Select --')); ?>" value="<?php echo e($location_name); ?>"
        ...
        <div class="form-group">
            ...
            <input type="text" name="address" id="customPlaceAddress" class="form-control"
                placeholder="<?php echo e(__('Real tour address')); ?>" value="<?php echo e($translation->address); ?>">
        </div>
        <?php if(is_default_lang()): ?>
            <div class="form-group">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Tour/Views/admin/tour/tour-location.blade.php ENDPATH**/ ?>