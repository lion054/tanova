    ...
    <div class="booking-history-manager">
        <?php if(!empty($vendor_payout_methods)): ?>
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php echo $__env->make("Vendor::frontend.payouts.request", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                <?php endif; ?>
                <div class="col-md-6">
                    <?php echo $__env->make("Vendor::frontend.payouts.setup", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        <?php else: ?>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Vendor/Views/frontend/payouts/index.blade.php ENDPATH**/ ?>