...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('hotel.admin.store', ['id' => $row->id ? $row->id : '-1', 'lang' => request()->query('lang')])); ?>"
        method="post">
        <?php echo csrf_field(); ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    <?php if($row->slug): ?>
                        <p class="item-url-demo"><?php echo e(__('Permalink')); ?>: <?php echo e(url(config('hotel.hotel_route_prefix'))); ?>/<a
                ...
                <div class="">
                    <?php if($row->id): ?>
                        <a class="btn btn-warning btn-xs"
                            href="<?php echo e(route('hotel.admin.room.index', ['hotel_id' => $row->id])); ?>" target="_blank"><i
                                class="fa fa-hand-o-right"></i> <?php echo e(__('Manage Rooms')); ?></a>
                    <?php endif; ?>
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-xs" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>"
                            target="_blank"><?php echo e(__('View Hotel')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <?php echo $__env->make('Hotel::admin.hotel.location', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Hotel/Views/admin/detail.blade.php ENDPATH**/ ?>