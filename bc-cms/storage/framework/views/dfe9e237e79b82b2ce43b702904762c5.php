...
<div class="footer <?php echo e($footer_classes); ?> <?php echo e($footerStyle); ?>">
    <div class="container">
        <?php switch($footerStyle):
            case ('style_4'): ?>
            <?php case ('style_5'): ?> <?php echo $__env->make('Layout::parts.footer-style.style_4', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <?php break; ?>
            <?php case ('style_7'): ?> <?php echo $__env->make('Layout::parts.footer-style.style_7', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <?php break; ?>
            <?php case ('style_8'): ?> <?php echo $__env->make('Layout::parts.footer-style.style_4',['logoStyle' => 'light'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <?php break; ?>
            <?php default: ?> <?php echo $__env->make('Layout::parts.footer-style.normal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endswitch; ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Layout/parts/footer-style/index.blade.php ENDPATH**/ ?>