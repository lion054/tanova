...
<?php $__env->startSection('content'); ?>
    <form class="overflow-y-auto d-flex"
        ...
        <div class="container-fluid overflow-y-auto d-flex flex-column">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    <?php if($row->slug): ?>
                        <p class="item-url-demo"><?php echo e(__('Permalink')); ?>: <?php echo e(url(config('tour.tour_route_prefix'))); ?>/<a
                                href="#" class="open-edit-input" data-name="slug"><?php echo e($row->slug); ?></a>
                        </p>
                    <?php endif; ?>
                </div>
                <div class="">
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>"
                            target="_blank"><?php echo e(__('View Tour')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="col-md-2 p-0">
                        <div class="card">
                            ...
                            <div class="list-group list-group-flush">
                                <a href="#tab_general" class="list-group-item list-group-item-action active"
                                    data-toggle="tab"><?php echo e(__('General')); ?></a>
                                <a href="#tab_location" class="list-group-item list-group-item-action" data-toggle="tab">
                                ...
                                <a href="#tab_status" class="list-group-item list-group-item-action "
                                    data-toggle="tab"><?php echo e(__('Status')); ?></a>
                                <a href="#tab_seo" class="list-group-item list-group-item-action "
                                    data-toggle="tab"><?php echo e(__('SEO')); ?></a>
                                <a href="#tab_tanova" class="list-group-item list-group-item-action"
                                    data-toggle="tab"><?php echo e(__('Tanova')); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-10 overflow-y-auto h-100">
                        <div class="d-flex flex-column overflow-y-auto h-100">
                            <div class="tab-content flex-grow-1 overflow-y-auto mb-3 p-1"
                                ...
                                <div class="tab-pane" id="tab_location">
                                    <?php echo $__env->make('Tour::admin/tour/tour-location', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                                <?php if($row->id): ?>
                                ...
                                <div class="tab-pane" id="tab_tanova">
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <?php if(is_default_lang()): ?>
                                                <div>
                                                    <label>
                                                        <input <?php if($row->status == 'publish'): ?> checked <?php endif; ?>
                                                            type="radio" name="status" value="publish">
                                                ...
                                                <div>
                                                    <label>
                                                        <input <?php if($row->status == 'draft'): ?> checked <?php endif; ?>
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <input type="checkbox" name="is_featured"
                                                        <?php if($row->is_featured): ?> checked <?php endif; ?> value="1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="default_state" class="custom-select">
                                                        <option value="1"
                                                            <?php if(old('default_state', $row->default_state ?? -1) == 1): ?> selected <?php endif; ?>>
                                                            <?php echo e(__('Always available')); ?></option>
                                                        <option value="0"
                                                            <?php if(old('default_state', $row->default_state ?? -1) == 0): ?> selected <?php endif; ?>>
        ...
        jQuery(function($) {
            new BCMapEngine('map_content', {
                ...
                ready: function(engineMap) {
                    ...
                    if (bookingCore.map_provider === "osm") {
...
<?php echo $__env->make('admin.layouts.app', ['body_class' => 'resource-edit-page'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Tour/Views/admin/detail.blade.php ENDPATH**/ ?>