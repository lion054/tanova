...
<?php $__env->startSection('content'); ?>
    <div class="row y-gap-20 justify-between items-end pb-20 lg:pb-40 md:pb-20">
        <div class="col-auto">
            <h1 class="text-30 lh-14 fw-600"><?php echo e($row->id ? __('Edit: ') . $row->title : __('Add new car')); ?></h1>
            <div class="text-15 text-light-1"><?php echo e(__('AI-native fleet management. Dispatch, tracking, and auto-invoicing built for operators.')); ?></div>
        </div>
        <div class="col-auto">
    ...
    <div class="lang-content-box">
        <form action="<?php echo e(route('car.vendor.store', ['id' => $row->id ? $row->id : '-1', 'lang' => request()->query('lang')])); ?>"
            method="post">
            <?php echo csrf_field(); ?>
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    <?php if(is_default_lang()): ?>
                        ...
                        <a data-bs-toggle="tab" data-bs-target="#nav-ical" aria-selected="false"><?php echo e(__('5. Ical')); ?></a>
                        <a data-bs-toggle="tab" data-bs-target="#nav-seo" aria-selected="false"><?php echo e(__('6. SEO')); ?></a>
                    <?php endif; ?>
                </div>
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-tour-content">
                        <?php echo $__env->make('Car::admin/car/content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php if(is_default_lang()): ?>
                    ...
                    <div class="tab-pane fade" id="nav-tour-location">
                        <?php echo $__env->make('Car::admin/car/location', ['is_smart_search' => '1'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <div class="tab-pane fade" id="nav-tour-pricing">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select name="default_state" class="custom-select">
                                                ...
                                                <option value="1" <?php if(old('default_state', $row->default_state ?? 0) == 1): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('Always available')); ?></option>
                                                <option value="0" <?php if(old('default_state', $row->default_state ?? 0) == 0): ?> selected <?php endif; ?>>
                        ...
                        <?php echo $__env->make('Car::admin/car/pricing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <?php if(is_default_lang()): ?>
                        <div class="tab-pane fade" id="nav-attribute">
                            <?php echo $__env->make('Car::admin/car/attributes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                        <div class="tab-pane fade" id="nav-ical">
                            <?php echo $__env->make('Car::admin.car.ical', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Car/Views/frontend/manageCar/detail.blade.php ENDPATH**/ ?>