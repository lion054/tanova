            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                        <?php echo \App\Helpers\AdminForm::select('currency_main',\App\Currency::getAll(),setting_item('currency_main','usd') ,'bc-select2'); ?>
                                    ...
                                    <div class="item" data-number="<?php echo e($key); ?>">
                                        <div class="row">
                                            <div class="col-md-11">
                                                ...
                                                <?php echo \App\Helpers\AdminForm::select('extra_currency['.$key.'][currency_main]',\App\Currency::getAll(),$item['currency_main'] ?? '','bc-select2'); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-11">
                                            <div class="form-group">
                                                <label class="" ><?php echo e(__("Sub Currency")); ?></label>
                                                <div class="form-controls">
                                            <?php echo \App\Helpers\AdminForm::select('extra_currency[__number__][currency_main]',\App\Currency::getAll(),'','bc-select2-lazy',true); ?>
...
<div class="row">
    ...
    <div class="col-md-8">
        <?php
            $all = \Modules\Order\Helpers\PaymentGatewayManager::all();
        ?>
        <?php $__currentLoopData = $all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$obj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $options = $obj->getOptionsConfigsFormatted();
            ?>
            <div class="panel">
                <div class="panel-title">
                    <i style="font-size: 20px" class="icon-check icon ion-ios-checkmark-circle mr-2  <?php if($obj->isAvailable()): ?> text-success <?php endif; ?>"></i>
                    <strong><?php echo e($obj->name); ?></strong>
...
<?php endif; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Order/Views/admin/settings/payment.blade.php ENDPATH**/ ?>