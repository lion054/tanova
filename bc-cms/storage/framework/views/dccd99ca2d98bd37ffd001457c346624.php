...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('space.admin.store', ['id' => $row->id ? $row->id : '-1', 'lang' => request()->query('lang')])); ?>"
        method="post">
        <?php echo csrf_field(); ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    <?php if($row->slug): ?>
                        <p class="item-url-demo"><?php echo e(__('Permalink')); ?>: <?php echo e(url('space')); ?>/<a href="#"
                ...
                <div class="">
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>"
                            target="_blank"><?php echo e(__('View Space')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        <?php echo $__env->make('Space::admin.space.content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php echo $__env->make('Space::admin.space.pricing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php if(is_default_lang()): ?>
                            
                        <?php endif; ?>
                        <?php echo $__env->make('Space::admin.space.location', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div class="col-md-3">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <?php if(is_default_lang()): ?>
                                    ...
                                    <div>
                                        <label><input <?php if($row->status == 'draft'): ?> checked <?php endif; ?> type="radio"
                        ...
                        <?php if(is_default_lang()): ?>
                                    ...
                                    <div class="form-group d-none">
                                        ...
                                        <label>
                                            <input type="checkbox" name="is_instant"
                                                <?php if($row->is_instant): ?> checked <?php endif; ?> value="1">
                                            <?php echo e(__('Enable instant booking')); ?>
                            ...
                            <?php echo $__env->make('Space::admin.space.attributes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <div class="panel">
                            ...
                            <?php echo $__env->make('Space::admin/space/ical', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Space/Views/admin/detail.blade.php ENDPATH**/ ?>