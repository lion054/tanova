            ...
            <div class="lang-content-box">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label ><?php echo e(__("Display type")); ?></label>

                                    <div>
                                        <label><input <?php if($row->show_template): ?> checked <?php endif; ?> type="radio" name="show_template" value="1"> <?php echo e(__("Template")); ?>

                                        </label></div>
                                    <div>
                                        <label><input <?php if(!$row->show_template): ?> checked <?php endif; ?> type="radio" name="show_template" value="0"> <?php echo e(__("Content")); ?>
                        ...
                        <?php if(is_default_lang()): ?>
                            <?php echo $__env->make('Page::admin.advanced', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <div class="panel">
                                <div class="panel-body">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Page/Views/admin/detail.blade.php ENDPATH**/ ?>