        ...
        <div class="row">
            <div class="col-md-6 d-flex align-content-center">
                <?php if(!empty($image_url)): ?>
                    <img class="i" src="<?php echo e($image_url); ?>" alt="Title">
                <?php endif; ?>
            </div>
            <div class="col-md-6">
...
<?php endif; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Template/Views/frontend/blocks/client-feedback/index.blade.php ENDPATH**/ ?>