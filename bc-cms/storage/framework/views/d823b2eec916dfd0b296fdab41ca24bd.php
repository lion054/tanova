...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Error'); ?> — Tsoka Travel Portal</title>
...
<body>
    <div class="card">
        ...
        <span class="error-icon"><?php echo $__env->yieldContent('icon', '⚠️'); ?></span>
        <div class="error-code"><?php echo $__env->yieldContent('code', ''); ?></div>
        <h1 class="error-title"><?php echo $__env->yieldContent('title', 'Something went wrong'); ?></h1>
        <p class="error-message"><?php echo $__env->yieldContent('message', 'An unexpected error occurred. Please try again.'); ?></p>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/resources/views/errors/layout.blade.php ENDPATH**/ ?>