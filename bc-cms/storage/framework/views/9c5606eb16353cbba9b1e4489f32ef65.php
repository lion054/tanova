<div class="form-group">
    <div class="row">
        <?php
        $config = config('bc.media.groups.private_verification');
        ?>
        ...
        <div class="col-md-<?php echo e($value_col_size ?? 4); ?> btn-upload-private-wrap">
                ...
                <?php if(!empty($old) and is_array($old)): ?>
                    <?php $__currentLoopData = $old; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            ...
                            <a target="_blank" href="<?php echo e(route('media.private.view',['code'=>$file['code'] ?? '','v'=>uniqid()])); ?>" class="file-item"><?php echo e($file['name']); ?> <i class="fa fa-download"></i></a>
                        </div>
            ...
            <?php if(empty($only_show_data)): ?>
                <span class="btn btn-primary btn-sm "><i class="fa fa-upload"></i> <?php echo e(__('Select Files')); ?>
                    ...
                    <input class="btn-upload-private-file" multiple data-name="verify_data_<?php echo e($field['id']); ?>[]"  data-multiple="true" type="file" accept="<?php echo e(implode(',', $config['mime'])); ?>">
                </span>
            <?php else: ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/User/Views/frontend/verification/fields/multi_files.blade.php ENDPATH**/ ?>