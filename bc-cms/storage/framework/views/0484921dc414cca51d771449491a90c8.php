...
<div class="bc_single_book_wrap d-flex justify-end">
    <div class="bc_single_book">
        ...
        <div id="bc_car_book_app" v-cloak class="px-30 py-30 rounded-4 border-light shadow-4 bg-white w-360 lg:w-full">
                                        ...
                                        <div class="row y-gap-10 justify-between items-center form-guest-search">
                                            ...
                                            <div class="col-auto">
                                                <div class="d-flex items-center js-counter"
                                                    ...
                                                    <span class="input"><input type="number" v-model="number"
                                                            min="0" /></span>
                                                    <button
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Car/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>