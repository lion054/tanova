        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class=""><?php echo e(__("Enable reCapcha Newsletter Subscribe Form")); ?></label>
                        <div class="form-controls">
                            <label><input type="checkbox" name="user_enable_subscribe_recaptcha" value="1" <?php if(!empty($settings['user_enable_subscribe_recaptcha'])): ?> checked <?php endif; ?> /> <?php echo e(__("On")); ?> </label>
                            <br>
                            <small class="form-text text-muted"><?php echo e(__("Turn on the mode for newsletter subscribe form")); ?></small>
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php if ($__env->exists('User::admin.settings._permanently_delete')) echo $__env->make('User::admin.settings._permanently_delete', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<hr>
<div class="row">
    <div class="col-sm-4">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/User/Views/admin/settings/user.blade.php ENDPATH**/ ?>