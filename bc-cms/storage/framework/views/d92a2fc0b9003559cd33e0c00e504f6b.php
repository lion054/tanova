<div class="panel">
    ...
    <div class="panel-body">
        ...
        <h3 class="panel-body-title" data-condition="enable_fixed_date:not(1)"><?php echo e(__('Date select type:')); ?></h3>
        <div class="form-group" data-condition="enable_fixed_date:not(1)">
            <div class="row">
                <div class="col-md-3">
                    <select name="date_select_type" class="form-control">
                        <option <?php if( $row->date_select_type == "datepicker"): ?> selected <?php endif; ?> value="datepicker"><?php echo e(__("Date picker")); ?></option>
                        <option <?php if( $row->date_select_type == "dropdown"): ?> selected <?php endif; ?> value="dropdown"><?php echo e(__("Dropdown")); ?></option>
                    </select>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Tour/Views/admin/tour/availability.blade.php ENDPATH**/ ?>