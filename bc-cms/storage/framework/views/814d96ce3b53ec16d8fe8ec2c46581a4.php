<form action="#" class="form bc-form-register" method="post">
    <?php echo csrf_field(); ?>
    ...
    <div class="row y-gap-20">
        ...
        <div class="col-12">
            <div class="form-input">
                <input minlength="8" type="password" name="password" autocomplete="off">
                <label class="lh-1 text-14 text-light-1"><?php echo e(__('Password')); ?></label>
            </div>
            <span class="invalid-feedback error error-password"></span>
            <span class="text-12 text-light-1"><?php echo e(__('Must be at least 8 characters and include at least one uppercase letter, one lowercase letter, and one number and one special character.')); ?></span>
        </div>
        <div class="col-12">
            <div class="d-flex">
        ...
        <div class="row y-gap-20 pt-30">
            ...
            <?php if(setting_item('twitter_enable')): ?>
                <a href="<?php echo e(url('social-login/twitter')); ?>" class="button col-12 -outline-dark-2 text-dark-2 py-15 rounded-8 mt-15">
                    <i class="fa fa-twitter text-15 mr-10"></i> <?php echo e(__('Login with X')); ?>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Layout/auth/register-form.blade.php ENDPATH**/ ?>