<?php $__env->startSection('title', 'Setup Telegram Bot'); ?>
...
<div class="setup-page">
    ...
    <div class="setup-content">
        ...
        <div class="setup-form-container">
            ...
            <form method="POST" action="<?php echo e(route('user.integrations.telegram')); ?>" class="setup-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="password"
                               ...
                               class="form-control <?php $__errorArgs = ['telegram_bot_token'];
...
unset($__errorArgs, $__bag); ?>"
                               ...
                               value="<?php echo e(old('telegram_bot_token')); ?>"
                               required>
                        ...
                        <?php $__errorArgs = ['telegram_bot_token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('vendor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Vendor/Views/frontend/integrations/telegram.blade.php ENDPATH**/ ?>