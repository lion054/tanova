...
<div class="tp-form-title"><?php echo e($page_title); ?></div>
<div class="tp-form-sub"><?php echo e($type === 'quotation' ? __("Create a professional quotation for your client.") : __("Create a professional invoice for your client.")); ?></div>

<?php echo $__env->make('admin.message', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<form method="POST" action="<?php echo e(route('tourpay.vendor.store', $row->id ?? -1)); ?>" id="tp-form">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="type"   id="tp-type-input"   value="<?php echo e(old('type',   $row->type   ?? $type)); ?>">
    ...
    <div class="tp-form-wrap">
        ...
        <div class="tp-form-main">
            ...
            <div class="tp-type-toggle">
                <button type="button" class="tp-type-btn <?php echo e(($row->type ?? $type) === 'invoice'   ? 'active' : ''); ?>" data-type="invoice"   onclick="setType('invoice')">
                    <i class="icofont-money"></i> <?php echo e(__("Invoice")); ?>

                </button>
                <button type="button" class="tp-type-btn <?php echo e(($row->type ?? $type) === 'quotation' ? 'active' : ''); ?>" data-type="quotation" onclick="setType('quotation')">
            ...
            <div class="tp-card">
                <div class="tp-card-header">
                    ...
                    <div class="tp-card-title"><?php echo e(__("Client Details")); ?></div>
                </div>
                <div class="tp-row">
                    <div class="tp-field">
                        <label><?php echo e(__("Full Name")); ?><span class="req">*</span></label>
                        <input type="text" name="client_name" value="<?php echo e(old('client_name', $row->client_name)); ?>" required placeholder="Jane Smith">
                    </div>
                    <div class="tp-field">
                        <label><?php echo e(__("Email Address")); ?></label>
                        <input type="email" name="client_email" value="<?php echo e(old('client_email', $row->client_email)); ?>" placeholder="jane@example.com">
                    </div>
                </div>
                <div class="tp-row">
                    <div class="tp-field">
                        <label><?php echo e(__("Phone Number")); ?></label>
                        <input type="text" name="client_phone" value="<?php echo e(old('client_phone', $row->client_phone)); ?>" placeholder="+27 83 000 0000">
                    </div>
                    <div class="tp-field">
                        <label><?php echo e(__("Country")); ?></label>
                        <input type="text" name="client_country" value="<?php echo e(old('client_country', $row->client_country)); ?>" placeholder="South Africa">
                    </div>
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Address")); ?></label>
                    <textarea name="client_address" rows="2" placeholder="<?php echo e(__('Street, City, Postal Code')); ?>"><?php echo e(old('client_address', $row->client_address)); ?></textarea>
                </div>
            </div>
            ...
            <div class="tp-card">
                <div class="tp-card-header">
                    ...
                    <div class="tp-card-title"><?php echo e(__("Service / Project")); ?> <span><?php echo e(__("optional")); ?></span></div>
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Title")); ?></label>
                    <input type="text" name="title" value="<?php echo e(old('title', $row->title)); ?>" placeholder="<?php echo e(__('e.g. Safari Package — Kruger 2026')); ?>">
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Description")); ?></label>
                    <textarea name="description" rows="3" placeholder="<?php echo e(__('Brief summary of what is included…')); ?>"><?php echo e(old('description', $row->description)); ?></textarea>
                </div>
            </div>
            ...
            <div class="tp-card">
                <div class="tp-card-header">
                    ...
                    <div class="tp-card-title"><?php echo e(__("Line Items")); ?></div>
                </div>
                <table class="tp-items-table">
                    <thead>
                        <tr>
                            <th style="width:38%"><?php echo e(__("Item / Description")); ?></th>
                            <th style="width:12%"><?php echo e(__("Qty")); ?></th>
                            <th style="width:20%"><?php echo e(__("Unit Price")); ?></th>
                            <th style="width:18%;text-align:right"><?php echo e(__("Total")); ?></th>
                            <th style="width:32px"></th>
                        </tr>
                    </thead>
                    <tbody id="tp-items-body">
                        <?php $items = old('items', $row->items->toArray() ?? []); ?>
                        ...
                        <tr class="tp-item-row">
                            <td>
                                <input type="text" name="items[<?php echo e($i); ?>][name]" value="<?php echo e($item['name']); ?>" placeholder="<?php echo e(__('Item name')); ?>">
                                <input type="text" name="items[<?php echo e($i); ?>][description]" value="<?php echo e($item['description'] ?? ''); ?>" placeholder="<?php echo e(__('Optional detail')); ?>" class="tp-item-sub-input">
                            </td>
                            <td><input type="number" name="items[<?php echo e($i); ?>][quantity]"   value="<?php echo e($item['quantity']   ?? 1); ?>" min="0" step="any" class="tp-qty"   oninput="recalc()"></td>
                            <td><input type="number" name="items[<?php echo e($i); ?>][unit_price]" value="<?php echo e($item['unit_price'] ?? 0); ?>" min="0" step="any" class="tp-price" oninput="recalc()"></td>
                            <td><div class="tp-item-total-cell tp-item-total"><?php echo e(number_format(($item['quantity'] ?? 1) * ($item['unit_price'] ?? 0), 2)); ?></div></td>
                            <td><button type="button" class="tp-remove-item" onclick="removeItem(this)"><i class="icofont-trash"></i></button></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr class="tp-item-row">
                            <td>
                                <input type="text" name="items[0][name]" placeholder="<?php echo e(__('Item name')); ?>">
                                <input type="text" name="items[0][description]" placeholder="<?php echo e(__('Optional detail')); ?>" class="tp-item-sub-input">
                            </td>
                ...
                <button type="button" class="tp-add-item" onclick="addItem()">
                    <i class="icofont-plus-circle"></i> <?php echo e(__("Add Line Item")); ?>
            ...
            <div class="tp-card">
                <div class="tp-card-header">
                    ...
                    <div class="tp-card-title"><?php echo e(__("Notes & Terms")); ?> <span><?php echo e(__("optional")); ?></span></div>
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Notes")); ?></label>
                    <textarea name="notes" rows="3" placeholder="<?php echo e(__('Thank you for your business…')); ?>"><?php echo e(old('notes', $row->notes)); ?></textarea>
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Payment Terms")); ?></label>
                    <textarea name="payment_terms" rows="2" placeholder="<?php echo e(__('e.g. 50% deposit on acceptance, balance before travel.')); ?>"><?php echo e(old('payment_terms', $row->payment_terms ?? setting_item('tourpay_default_payment_terms'))); ?></textarea>
                </div>
            </div>
        ...
        <div class="tp-form-side">
            ...
            <div class="tp-card">
                <div class="tp-card-header" style="margin-bottom:14px;">
                    ...
                    <div class="tp-card-title"><?php echo e(__("Template")); ?></div>
                </div>
                <div class="tp-templates">
                    <?php $selectedTpl = old('template', $row->template ?? 1); ?>
                    <?php $__currentLoopData = [1=>'Classic',2=>'Modern',3=>'Bold',4=>'Safari',5=>'Minimal']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tnum => $tname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tp-tpl tp-tpl-<?php echo e($tnum); ?> <?php echo e($selectedTpl == $tnum ? 'selected' : ''); ?>" onclick="selectTemplate(<?php echo e($tnum); ?>)">
                ...
                <input type="hidden" name="template" id="tp-template-input" value="<?php echo e(old('template', $row->template ?? 1)); ?>">
            </div>
            ...
            <div class="tp-card">
                <div class="tp-card-header" style="margin-bottom:14px;">
                    ...
                    <div class="tp-card-title"><?php echo e(__("Financials")); ?></div>
                </div>
                <div class="tp-field">
                    ...
                    <select name="currency">
                        ...
                        <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($code); ?>" <?php echo e($selectedCur == $code ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Tax Rate (VAT %)")); ?></label>
                    <input type="number" name="tax_rate" id="tp-tax-rate"
                           value="<?php echo e(old('tax_rate', $row->tax_rate ?? setting_item('tourpay_default_vat',15))); ?>"
                           min="0" max="100" step="any"
                           oninput="recalc(); document.getElementById('tp-tax-rate-label').textContent = this.value">
                </div>
                <div class="tp-summary">
                    <div class="tp-summary-row">
                        <span><?php echo e(__("Excl. VAT")); ?></span>
                        <span id="tp-subtotal">0.00</span>
                    </div>
                    <div class="tp-summary-row">
                        <span><?php echo e(__("VAT")); ?> (<span id="tp-tax-rate-label"><?php echo e(old('tax_rate', $row->tax_rate ?? setting_item('tourpay_default_vat',15))); ?></span>%)</span>
                        <span id="tp-tax">0.00</span>
                    </div>
                </div>
                <div class="tp-side-total-wrap">
                    <div class="tp-side-total-label"><?php echo e(__("Total Due")); ?></div>
                    <div class="tp-side-total-amount">
                        <span class="tp-side-total-currency" id="tp-currency-display"><?php echo e($selectedCur); ?></span><span id="tp-total">0.00</span>
                    </div>
                </div>
            </div>
            ...
            <div class="tp-card">
                <div class="tp-card-header" style="margin-bottom:14px;">
                    ...
                    <div class="tp-card-title"><?php echo e(__("Schedule")); ?></div>
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Status")); ?></label>
                    <select name="status">
                        <?php $selectedStatus = old('status', $row->status ?? 'draft'); ?>
                        <?php $__currentLoopData = ['draft','sent','paid','accepted','cancelled','expired']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($st); ?>" <?php echo e($selectedStatus == $st ? 'selected' : ''); ?>><?php echo e(ucfirst($st)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Issue Date")); ?></label>
                    <input type="date" name="issue_date" value="<?php echo e(old('issue_date', $row->issue_date ? $row->issue_date->format('Y-m-d') : date('Y-m-d'))); ?>">
                </div>
                <div class="tp-field">
                    <label><?php echo e(__("Due Date")); ?></label>
                    <input type="date" name="due_date" value="<?php echo e(old('due_date', $row->due_date ? $row->due_date->format('Y-m-d') : '')); ?>">
                </div>
                <div class="tp-field" id="tp-valid-days-wrap" style="<?php echo e(($row->type ?? $type) !== 'quotation' ? 'display:none' : ''); ?>">
                    <label><?php echo e(__("Valid For (days)")); ?></label>
                    <input type="number" name="valid_days" value="<?php echo e(old('valid_days', $row->valid_days ?? setting_item('tourpay_default_valid_days', 30))); ?>" min="1">
                </div>
            </div>
            ...
            <div class="tp-save-bar">
                <button type="button" class="tp-save-btn tp-save-btn-draft" onclick="submitForm('draft')">
                    <i class="icofont-save"></i> <?php echo e(__("Save Draft")); ?>

                </button>
                <button type="button" class="tp-save-btn tp-save-btn-send" onclick="submitForm('send')">
                    <i class="icofont-paper-plane"></i> <?php echo e(__("Save & Send")); ?>
...
<script>
var itemIndex = <?php echo e(count($items ?? [])); ?>;
...
function addItem() {
    ...
    tr.innerHTML =
        '<td>'
        + '<input type="text" name="items['+i+'][name]" placeholder="<?php echo e(__("Item name")); ?>">'
        + '<input type="text" name="items['+i+'][description]" placeholder="<?php echo e(__("Optional detail")); ?>" class="tp-item-sub-input">'
        + '</td>'
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/TourPay/Views/frontend/form.blade.php ENDPATH**/ ?>