            ...
            <div class="toggle-element -dropdown-2 js-click-dropdown js-actions-<?php echo e($key + 1); ?>-toggle">
                <div class="text-14 fw-500 js-dropdown-list">
                    ...
                    <div><a href="<?php echo e(route('user.booking.invoice',['code'=>$booking->code])); ?>" class="d-block js-dropdown-link btn-info-booking open-new-window" onclick="window.open(this.href); return false;"><?php echo e(__("Invoice")); ?></a></div>
                        <?php if(in_array($booking->status,[\Modules\Booking\Models\Booking::COMPLETED,\Modules\Booking\Models\Booking::PAID]) and isPro() ): ?>
                            <div>
                                <a
                                    href="<?php echo e(route('user.booking.ticket',['code'=>$booking->code])); ?>"
                                    class="d-block js-dropdown-link btn-info-booking open-new-window"
                                    onclick="window.open(this.href); return false;"
                                ><?php echo e(__("Print Ticket")); ?></a>
                            </div>
                        <?php endif; ?>
                    <?php if($booking->status == 'unpaid'): ?>
                            <a href="<?php echo e(route('booking.checkout',['code'=>$booking->code])); ?>" class="d-block js-dropdown-link btn-info-booking">
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Event/Views/bookingHistory/loop.blade.php ENDPATH**/ ?>