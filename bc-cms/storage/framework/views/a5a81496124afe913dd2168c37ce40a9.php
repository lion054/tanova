...
<?php $__env->startSection('content'); ?>
    <form
        action="<?php echo e(route('support.admin.topic.category.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post"
    >
        <?php echo csrf_field(); ?>
        <div class="container">
                ...
                <div class="">
                    ...
                    <?php if($row->slug): ?>
                        <p class="item-url-demo"> <?php echo e(__('Permalink:')); ?>
                            ...
                            <?php echo e(url((request()->query('lang') ? request()->query('lang').'/' : '').config('support.topic_route_prefix')."/".config('support.topic_category_route_prefix'))); ?>/
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <?php echo $__env->make('Support::admin/topic/category/form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/pro/Support/Views/admin/topic/category/detail.blade.php ENDPATH**/ ?>