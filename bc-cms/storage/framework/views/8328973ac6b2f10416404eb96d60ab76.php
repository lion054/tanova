...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("All Course")); ?></h1>
            <div class="title-actions">
                <a href="<?php echo e(route('course.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new course")); ?></a>
            </div>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(route('course.admin.bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
            ...
            <div class="col-left">
                <form method="get" action="<?php echo e(route('course.admin.index')); ?> " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    <?php if(!empty($rows) and $course_manage_others): ?>
                        <?php
                            $user = !empty(Request()->author_id) ? App\User::find(Request()->author_id) : false;
                ...
                <form action="" class="bc-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th width="130px"> <?php echo e(__('Category')); ?></th>
                            <th width="130px"> <?php echo e(__('Teacher')); ?></th>
                            <th width="130px"> <?php echo e(__('Students')); ?></th>
                        ...
                        <?php if($rows->total() > 0): ?>
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($row->status); ?>">
                                    ...
                                    <td class="title">
                                        <a href="<?php echo e(route('course.admin.edit',['id'=>$row->id])); ?>"><?php echo e($row->title); ?></a>
                                    </td>
                                    <td><?php echo e($row->category->name ?? ''); ?></td>
                                    <td>
                                        <?php if(!empty($row->author)): ?>
                                            <?php echo e($row->author->display_name); ?>

                                        <?php else: ?>
                                            <?php echo e(__("[Teacher Deleted]")); ?>

                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <span  class="badge badge-primary">
                                            <?php echo e($row->students_count); ?>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="<?php echo e(route('course.admin.edit',['id'=>$row->id])); ?>" ><?php echo e(__('Edit')); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Course/Views/admin/index.blade.php ENDPATH**/ ?>