<?php
    ...
    if ($style == 'space_form_search') {
        $classes =
            'form-search-all-service mainSearch bg-white px-20 py-20 lg:px-20 lg:pt-5 lg:pb-20 rounded-100 shadow-2 mt-40 -w-900';
        $button_classes = ' -blue-1 py-20 px-35 col-12 rounded-100 bg-dark-4 text-white';
    }
?>
<form action="<?php echo e(route('space.search')); ?>" class="gotrip_form_search bc_form_search bc_form form <?php echo e($classes); ?>"
    method="get">
                ...
                <?php $__currentLoopData = $space_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-<?php echo e($field['size'] ?? '6'); ?> align-self-center px-30 lg:py-20 lg:px-0">
                        ...
                        <?php switch($field['field']):
                            case ('service_name'): ?>
                                <?php echo $__env->make('Layout::common.search.fields.service_name', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php break; ?>

                            <?php case ('location'): ?>
                                <?php echo $__env->make('Layout::common.search.fields.location', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php break; ?>

                            <?php case ('date'): ?>
                                <?php echo $__env->make('Layout::common.search.fields.date', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php break; ?>

                            <?php case ('attr'): ?>
                                <?php echo $__env->make('Layout::common.search.fields.attr', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php break; ?>

                            <?php case ('guests'): ?>
                                <?php echo $__env->make('Layout::common.search.fields.guests', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php break; ?>
                        <?php endswitch; ?>
                    </div>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Space/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>