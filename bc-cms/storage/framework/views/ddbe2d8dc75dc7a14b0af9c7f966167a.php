            ...
            <div class="row y-gap-30 pt-40 sm:pt-20">
                <?php $__currentLoopData = $tour_related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <?php echo $__env->make('Tour::frontend.layouts.search.loop-grid',['row'=>$item,'include_param'=>0], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/GoTrip/Tour/Views/frontend/layouts/details/tour-related.blade.php ENDPATH**/ ?>