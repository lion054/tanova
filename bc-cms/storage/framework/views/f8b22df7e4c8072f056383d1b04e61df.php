    ...
    <td width="2%">
        ...
        <?php endif; ?>
            <?php if(!empty(setting_item("flight_allow_vendor_can_change_paid_amount"))): ?>
                ...
                <?php if ($__env->exists($service->set_paid_modal_file ?? '')) echo $__env->make($service->set_paid_modal_file ?? '', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
    </td>
</tr>
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/themes/Base/Flight/Views/frontend/bookingReport/loop.blade.php ENDPATH**/ ?>