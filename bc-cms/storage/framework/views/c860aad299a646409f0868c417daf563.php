<script type="text/x-template" id="bc-order-item-template">
    <div class="item" data-number="1">
        <div class="row">
            <div class="col-md-4">
                <bc-select2 v-if="is_editable" placeholder="<?php echo e(__('-- Select Product --')); ?>" :settings="product_settings" :options="product_options" v-model="item.product_id" @select="productChangeEvent"/>
            ...
            <div class="col-md-2">
                <select class="form-control" v-show="product.product_type == 'variable'" v-model="item.variation_id" @change="variationChange">
                    <option value=""><?php echo e(__("-- Select Variation --")); ?></option>
...
<?php /**PATH /home/lionel/Documents/Junkyard/gotrip/bc-cms/modules/Order/Views/admin/order/detail/components/item.blade.php ENDPATH**/ ?>