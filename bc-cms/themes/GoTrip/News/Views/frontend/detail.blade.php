                            ...
                            <div class="col-auto">
                                <div class="d-flex items-center">
                                    ...
                                    <div class="d-flex items-center">
                                        ...
                                        <a href="https://twitter.com/share?url={{$row->getDetailUrl()}}&amp;title={{$translation->title}}" target="_blank" original-title="{{__("X")}}" class="flex-center size-40 rounded-full"><i class="icon-twitter text-14"></i></a>
