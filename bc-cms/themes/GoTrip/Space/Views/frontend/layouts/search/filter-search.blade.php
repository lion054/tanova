<div class="bc_filter sidebar">
    ...
    @endif
    <form action="{{ route('space.search') }}" class="bc_form_filter lg:d-none" data-x="filterPopup"
        data-x-toggle="-is-active">

        <div
            class="g-filter-item sidebar__item @if (!$layout || $layout == 'normal') -no-border @endif pt-20 mb-30 lg:d-none">
            <div class="flex-center ratio ratio-15:9 js-lazy"
                data-bg="{{ get_file_url(setting_item('space_map_image'), 'full') }}">
