...
@section('content')
    <div class="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
        <div class="col-auto">
            ...
            <div class="text-15 text-light-1">{{ __('AI-native event management. Live ticketing, attendee automation, and smart distribution.') }}</div>
        </div>
            ...
            <div class="panel-body">
                <div class="filter-div d-flex justify-content-between ">
                    ...
                    <div class="col-right">
                        @if ($rows->total() > 0)
                            <span
                                class="count-string">{{ __('Showing :from - :to of :total events', ['from' => $rows->firstItem(), 'to' => $rows->lastItem(), 'total' => $rows->total()]) }}</span>
                        @endif
                    </div>
                </div>
            </div>
