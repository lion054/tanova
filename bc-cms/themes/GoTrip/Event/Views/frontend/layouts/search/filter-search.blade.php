...
@endif
<form action="{{ route('event.search') }}" class="bc_form_filter bc_filter lg:d-none" data-x="filterPopup"
            ...
            <div class="row x-gap-10 y-gap-30">
                <div class="col-12">
                    <div class="js-price-searchPage">
                        ...
                        <button type="submit"
                            class=" btn-apply-price-range flex-center bg-blue-1 rounded-4 px-3 py-1 mt-3 text-12 fw-600 text-white">{{ __('APPLY') }}</button>
                    </div>
                </div>
            </div>
        </div>
