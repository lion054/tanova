        ...
        <div id="bc_boat_book_app" class="px-30 py-30 rounded-4 border-light bg-white w-360 lg:w-full shadow-4" v-cloak>
            ...
            <div class="d-flex justify-between items-center">
                <div class="text-14 text-light-1">
                    <span class="value">
                        <div><span
                                class="text-20 fw-500 text-dark-1">{{ format_money($row->price_per_hour) }}</span><small>{{ __('/per hour') }}</small>
                        </div>
                        <div class="lh-1"><span
                                class="text-20 fw-500 text-dark-1">{{ format_money($row->price_per_day) }}</span><small>{{ __('/per day') }}</small>
                        </div>
                    </span>
                </div>
                    ...
                    <div class="row y-gap-20 pt-20">
                                        ...
                                        <div class="input-number-group">
                                            <select v-model="start_time" class="form-control"
                                                ...
                                                @for ($i = $startTime; $i <= $endTime; $i = $i + 1800)
                                                    <option value="{{ date('H:i', $i) }}">{{ date('H:i', $i) }}
                                                    </option>
                                                @endfor
                                            </select>
                                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-section-group px-20 py-10 border-light rounded-4">
                                <h4 class="form-section-title text-15 fw-500 ls-2 lh-16">{{ __('Extra prices:') }}
                                </h4>
