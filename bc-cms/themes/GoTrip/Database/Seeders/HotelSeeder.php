...
class HotelSeeder extends Seeder
{
    ...
    {
        $hotel_images = [
            DB::table('media_files')->insertGetId(['file_name' => 'hotel-1', 'file_path' => 'gotrip/hotel/1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'hotel-2', 'file_path' => 'gotrip/hotel/2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'hotel-3', 'file_path' => 'gotrip/hotel/3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'hotel-4', 'file_path' => 'gotrip/hotel/4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'hotel-5', 'file_path' => 'gotrip/hotel/5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'hotel-6', 'file_path' => 'gotrip/hotel/6.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'hotel-7', 'file_path' => 'gotrip/hotel/7.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'hotel-8', 'file_path' => 'gotrip/hotel/8.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        $list_gallery = [
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-1', 'file_path' => 'gotrip/hotel/g-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-2', 'file_path' => 'gotrip/hotel/g-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-3', 'file_path' => 'gotrip/hotel/g-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-4', 'file_path' => 'gotrip/hotel/g-4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-5', 'file_path' => 'gotrip/hotel/g-5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-6', 'file_path' => 'gotrip/hotel/g-6.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-7', 'file_path' => 'gotrip/hotel/g-7.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-8', 'file_path' => 'gotrip/hotel/g-8.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-9', 'file_path' => 'gotrip/hotel/g-9.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-10', 'file_path' => 'gotrip/hotel/g-10.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-11', 'file_path' => 'gotrip/hotel/g-11.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'gallery-12', 'file_path' => 'gotrip/hotel/g-12.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        ...
        $gotrip_new_hotel_title = [
            'Hotel Stanford','Hotel WBF Hommachi','Castello Casole Hotel','Redac Gateway Hotel','Studio Allston Hotel','EnVision Hotel Boston','Crowne Plaza Hotel','Stewart Hotel','Parian Holiday Villas','Dylan Hotel','The May Fair Hotel'
        ];

        for ($loc = 1; $loc <= 4; $loc++){
            for ($j = 1; $j <= 8; $j++){
                $IDs_vendor[] = $create_user =  rand(1,6);
                $title = $gotrip_new_hotel_title[rand(0,10)];
                $IDs[] = DB::table('bc_hotels')->insertGetId(
                    [
                        'title' => $title,
                        'slug' => Str::slug($title),
