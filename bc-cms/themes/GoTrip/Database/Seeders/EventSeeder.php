...
class EventSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $list_images = [
            DB::table('media_files')->insertGetId(['file_name' => 'event-1', 'file_path' => 'gotrip/event/1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'event-2', 'file_path' => 'gotrip/event/2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'event-3', 'file_path' => 'gotrip/event/3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'event-4', 'file_path' => 'gotrip/event/4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'event-5', 'file_path' => 'gotrip/event/5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'event-6', 'file_path' => 'gotrip/event/6.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'event-7', 'file_path' => 'gotrip/event/7.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'event-8', 'file_path' => 'gotrip/event/8.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'event-9', 'file_path' => 'gotrip/event/9.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        ...
        foreach (['Camping','Trekking','Camp Fire','Off Road','Exploring'] as $k => $term){
            $t = new \Modules\Core\Models\Terms([
                'name'=>$term,
                'attr_id'=>$termFeature->id,
                'icon' => $termIcon[$k]
            ]);
            $t->save();
            $termFeatureIds[] = $t->id;
        ...
        foreach ($IDs as $feature_id){
            foreach ($termFeatureIds as $k=>$term_id) {
                if( rand(0 , count($termFeatureIds) ) == $k) continue;
                if( rand(0 , count($termFeatureIds) ) == $k) continue;
                if( rand(0 , count($termFeatureIds) ) == $k) continue;
