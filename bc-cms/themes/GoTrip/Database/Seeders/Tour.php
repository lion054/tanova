...
class Tour extends Seeder
{
    ...
    public function run()
    {
        ...
        $list_images = [
            DB::table('media_files')->insertGetId(['file_name' => 'tour-1', 'file_path' => 'gotrip/tour/1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-2', 'file_path' => 'gotrip/tour/2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-3', 'file_path' => 'gotrip/tour/3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-4', 'file_path' => 'gotrip/tour/4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-5', 'file_path' => 'gotrip/tour/5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-6', 'file_path' => 'gotrip/tour/6.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-7', 'file_path' => 'gotrip/tour/7.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-8', 'file_path' => 'gotrip/tour/8.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-9', 'file_path' => 'gotrip/tour/9.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        $list_itinerary = [
            DB::table('media_files')->insertGetId(['file_name' => 'itinerary-1', 'file_path' => 'gotrip/tour/itinerary/1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];


        $categories =  [
            ['name' => 'Wildlife Tour', 'content' => '', 'status' => 'publish', 'cat_icon' => 'icon-nature'],
            ['name' => 'Adventure Tour', 'content' => '', 'status' => 'publish', 'cat_icon' => 'icon-hiking'],
            ['name' => 'City Tours', 'content' => '', 'status' => 'publish', 'cat_icon' => 'icon-city'],
            ['name' => 'Museum Tours', 'content' => '', 'status' => 'publish', 'cat_icon' => 'icon-museum'],
            ['name' => 'Beaches Tour', 'content' => '', 'status' => 'publish', 'cat_icon' => 'icon-beach-umbrella']
        ];
        ...
        $IDs[] = DB::table('bc_tours')->insertGetId(
            [
                ...
                'itinerary' =>  '[{"image_id":"'.$list_itinerary[0].'","title":"Day 1","desc":"Los Angeles","content":"There are no activities planned until an evening welcome meeting. Additional Notes: We highly recommend booking pre-tour accommodation to fully experience this crazy city."},{"image_id":"'.$list_itinerary[0].'","title":"Day 2","desc":"Lake Havasu City","content":"Pack up the van in the morning and check out the stars on the most famous sidewalk in Hollywood on an orientation tour"},{"image_id":"'.$list_itinerary[0].'","title":"Day 3","desc":"Las Vegas\/Bakersfield","content":"Travel to one of the country\'s most rugged landscapes \u2014 the legendary Death Valley, California. Soak in the dramatic landscape. In the afternoon, continue on to Bakersfield for the night."},{"image_id":"'.$list_itinerary[0].'","title":"Day 4","desc":"San Francisco","content":"We highly recommend booking post-accommodation to fully experience this famous city."}]',
            ]);
        $IDs_vendor[] = $create_user =  "1";
        $IDs[] = DB::table('bc_tours')->insertGetId(
            [
