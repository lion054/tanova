<?php
namespace Themes\Tsoka\Database\Seeders;
...
class General extends  Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('core_settings')->insert(
            [
                ...
                [
                    ...
                    'val'   => '[{"title":"Address","content":"328 Queensberry Street, North Melbourne VIC 3051, Australia."},{"title":"Toll Free Customer Care","content":"+(1) 123 456 7890"},{"title":"Need live support?","content":"hello@tsokatravel.com"},{"title":"Follow us on social media","content":"<a href=\"#\"><i class=\"icon-facebook text-14\"><\/i><\/a>\r\n<a href=\"#\"><i class=\"icon-twitter text-14\"><\/i><\/a>\r\n<a href=\"#\"><i class=\"icon-instagram text-14\"><\/i><\/a>\r\n<a href=\"#\"><i class=\"icon-linkedin text-14\"><\/i><\/a>"}]',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>Tsoka</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
        ...
        DB::table('core_settings')->insert([
            ...
            [
                ...
                'val' => '<div class="row x-gap-15 y-gap-15 items-center">
                              ...
                              <div class="col-auto">
                                <a href="#" class="text-12 text-white">hello@tsokatravel.com</a>
                              </div>
                         </div>',
                'group' => "general"
            ],
        ...
        DB::table('core_settings')->insert([
            ...
            [
                'name' => "email_header",
                'val' => '<h1 class="site-title" style="text-align: center">Tsoka</h1>',
                'group' => "general",
            ],
            [
                'name' => "email_footer",
                'val' => '<p class="" style="text-align: center">&copy; 2023 Tsoka. All rights reserved</p>',
                'group' => "general",
            ],
            [
            ...
            [
                ...
                'val' => '<h1 style="text-align: center">Welcome!</h1>
                    ...
                    <p>Thank you for signing up with Tsoka! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>Tsoka</p>',
                'group' => "user",
            ],
        ...
        DB::table('core_settings')->insert([
            ...
            [
                ...
                'val' => "<p><span style=\"font-size: 14pt;\"><strong>Tsoka Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
                                <p>tsokatravel.com</p>",
                'group' => "booking",
            ],
        ...
        $home2 = [
            ...
            [
                ...
                "model" => [
                    ...
                    "sub_title" => "Book in advance or last-minute with Tsoka. Receive instant confirmation. Access your booking info offline.",
        ...
        $home_car = [
            ...
            [
                ...
                'model' => [
                    'title' => 'Tsoka is a World Leading Car Hire Booking Platform',
        ...
        $home_boat = [
            ...
            [
                ...
                "name" => "Text Image",
                "model" => [
                    "title" => "Tsoka is a World Leading Cruise Booking Platform",
                    "desc" => "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.",
                    "link_title" => "Learn More",
