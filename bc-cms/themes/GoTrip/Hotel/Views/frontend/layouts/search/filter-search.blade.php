<div class="bc_filter sidebar">
    ...
    @endif
    <form action="{{ route('hotel.search') }}" class="bc_form_filter lg:d-none" data-x="filterPopup"
        ...
        <aside class="sidebar y-gap-40 p-4 p-lg-0">
            ...
            <div class="g-filter-item sidebar__item -no-border">
                <div class="flex-center ratio ratio-15:9 js-lazy"
                    data-bg="{{ get_file_url(setting_item('hotel_map_image'), 'full') }}">
                    <a href="{{ route('hotel.search', ['_layout' => 'map']) }}"
