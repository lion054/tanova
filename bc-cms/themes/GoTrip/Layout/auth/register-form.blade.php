<form action="#" class="form bc-form-register" method="post">
    ...
    <div class="row y-gap-20">
        ...
        <div class="col-12">
            ...
            <span class="text-12 text-light-1">{{ __('Must be at least 8 characters and include at least one uppercase letter, one lowercase letter, and one number and one special character.') }}</span>
        </div>
        <div class="col-12">
            <div class="d-flex">
        ...
        <div class="row y-gap-20 pt-30">
            ...
            @if(setting_item('twitter_enable'))
                <a href="{{url('social-login/twitter')}}" class="button col-12 -outline-dark-2 text-dark-2 py-15 rounded-8 mt-15">
                    <i class="fa fa-twitter text-15 mr-10"></i> {{ __('Login with X') }}
                </a>
            @endif
        </div>
    @endif
