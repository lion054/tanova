                ...
                <div class="row y-gap-15 items-center justify-between">
                    <div class="col-auto">
                        <div class="text-14 text-light-1">
                            {{ __('From') }}
                            <span class="text-14 text-red-1 line-through">{{ format_money($row->original_price) }}</span>
                            <span class="text-20 fw-500 text-dark-1">{{ format_money($row->price) }}</span>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="searchMenu-guests px-20 py-10 border-light rounded-4 js-form-dd">
                                    <div data-x-dd-click="searchMenu-guests">
                                        <h4 class="text-15 fw-500 ls-2 lh-16">{{ __('Applications') }}</h4>
                                    ...
                                    <div class="searchMenu-guests__field shadow-2" data-x-dd="searchMenu-guests"
                                        ...
                                        <div class="bg-white px-30 py-30 rounded-4">
                                            <div class="row y-gap-10 justify-between items-center form-guest-search">
                                                <div class="col-auto">
                                                    <div class="text-15 fw-500">{{ __('Applications') }}</div>
                                                </div>
                                                <div class="col-auto">
