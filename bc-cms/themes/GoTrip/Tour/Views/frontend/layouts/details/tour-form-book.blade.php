    ...
    <div class="w-360 lg:w-full d-flex flex-column items-center">
            ...
            <div id="bc_tour_book_app" v-cloak>
                ...
                <div class="d-flex items-center pt-20">
                    ...
                    <div class="text-14 lh-16 ml-10">
                        {{ __(':number% of travelers recommend this experience', ['number' => $row->recommend_percent]) }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="px-30">
            <div class="text-14 text-light-1 mt-30">
                {{ __('Not sure? You can cancel this reservation up to 24 hours in advance for a full refund.') }}
            </div>
        </div>
    </div>
</div>
