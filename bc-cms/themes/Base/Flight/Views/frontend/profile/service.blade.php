...
@if(!empty($services) and $services->total())
    <div class="bc-profile-list-services">
        @include('Flight::frontend.blocks.list-flight.index', ['rows'=>$services,'style_list'=>'normal','desc'=>' ','title'=>!empty($view_all) ? __('Flight by :name',['name'=>$user->first_name]) :'','col'=>4])
