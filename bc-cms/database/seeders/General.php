...
<a href="mailto:contact@bookingcore.test">contact@bookingcore.test</a>',
                ...
                [
                    ...
                    'val'   => 'Copyright © 2024 by Tsoka Travel',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>Tsoka Travel</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
...
<p>This document was last updated on October 6, 2020</p>';
        ...
        $settings = [
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">Tsoka Travel</h1>',
                    'group' => "general",
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2019 Tsoka Travel. All rights reserved</p>',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    <p>Thank you for signing up with Tsoka Travel! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>Tsoka Travel</p>',
                    'group' => "user",
                ],
            ...
            [
                ...
                [
                    ...
                    'val'   => "<p><span style=\"font-size: 14pt;\"><strong>Tsoka Travel Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
