...
@section('container')
    <div class="tabs tabs-full">
        ...
        <input id="tab1" type="radio" name="tabs" value="tab1" class="tab-input" @if(old('tabs','tab1') == 'tab1') checked @endif />
        <input id="tab2" type="radio" name="tabs" value="tab2" class="tab-input" @if(old('tabs') == 'tab2') checked @endif />
        <input id="tab3" type="radio" name="tabs" value="tab3" class="tab-input" @if(old('tabs') == 'tab3') checked @endif />
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group d-none {{ $errors->has('database_connection') ? ' has-error ' : '' }}"
                    style="display: none">
                ...
                <div class="form-group {{ $errors->has('admin_email') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="admin_email" id="admin_email" maxlength="100" value="{{ old('admin_email') }}" required
                        placeholder="{{ trans('installer_messages.environment.wizard.form.app_admin_email_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('admin_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="admin_password" id="admin_password" value="" minlength="8" required
                        placeholder="{{ trans('installer_messages.environment.wizard.form.app_admin_password_placeholder') }}" />
                ...
                <div class="buttons">
                    <span class="button bc_test_db" style="font-size: 17px;">{{ __('Test DB') }}</span>
