        ...
        <div class="container-fluid overflow-y-auto d-flex flex-column">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    @if ($row->slug)
                        <p class="item-url-demo">{{ __('Permalink') }}: {{ url(config('tour.tour_route_prefix')) }}/<a
                        ...
                        <div class="d-flex flex-column overflow-y-auto h-100">
                            <div class="tab-content flex-grow-1 overflow-y-auto mb-3 p-1"
                                ...
                                <div class="tab-pane" id="tab_tanova">
                                    @include('Tour::admin/tour/tanova')
                                </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            @if (is_default_lang())
                                                <div>
                                                    <label>
                                                        <input @if ($row->status == 'publish') checked @endif
                                                ...
                                                <div>
                                                    <label>
                                                        <input @if ($row->status == 'draft') checked @endif
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="default_state" class="custom-select">
                                                        <option value="1"
                                                            @if (old('default_state', $row->default_state ?? -1) == 1) selected @endif>
                                                            {{ __('Always available') }}</option>
                                                        <option value="0"
                                                            @if (old('default_state', $row->default_state ?? -1) == 0) selected @endif>
