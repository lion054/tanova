...
class PlanController extends AdminController
{
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ['name' => __('Vendor Plans'), 'url' => route('vendor.admin.plan.index')],
                ['name' => __('Add Plan'), 'class' => 'active'],
            ],
        ];
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs'  => [
                ['name' => __('Vendor Plans'), 'url' => route('vendor.admin.plan.index')],
                ['name' => __('Edit Plan'), 'class' => 'active'],
            ],
        ];
        return view('Vendor::admin.plan.detail', $data);
    }
    ...
    {
        return apply_filters('vendor_plan_service_types', [
            'hotel'  => __('Hotel'),
            'tour'   => __('Tour'),
            'car'    => __('Car'),
            'boat'   => __('Boat'),
