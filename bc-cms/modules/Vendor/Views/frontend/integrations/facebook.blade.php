...
@section('title', 'Setup Facebook Messenger')
...
<div class="setup-page">
    ...
    <div class="setup-content">
        ...
        <div class="setup-form-container">
            ...
            <form method="POST" action="{{ route('user.integrations.facebook') }}" class="setup-form">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('facebook_page_id', Auth::user()->facebook_page_id) }}"
                               required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="password"
                               ...
                               class="form-control @error('facebook_access_token') is-invalid @enderror"
                               placeholder="EAAxxxxxxx..."
                               value="{{ old('facebook_access_token') }}"
                               required>
