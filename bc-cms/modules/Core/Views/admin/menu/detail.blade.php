                ...
                <div v-for="(type,index) in item_types" class="panel panel-toggle-able">
                    ...
                    <div class="panel-body" v-show="type.open">
                        ...
                        <div class="text-right">
                            <span class="btn btn-sm btn-primary" v-on:click="addToMenu(type)">{{__('Add to Menu')}}</span>
                        </div>
                    </div>
                </div>
                <div class="panel panel-toggle-able">
                    <div class="panel-title" v-on:click="custom_show = custom_show ? false : true">{{__('Custom Url')}}
                        <i class="icon ion-md-arrow-dropdown"></i>
                    </div>
                    <div class="panel-body" v-show="custom_show">
                        ...
                        <div class="text-right">
                            <span class="btn btn-sm btn-primary" v-on:click="addCustomUrl">{{__('Add to Menu')}}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-8 col-xl-9">
                ...
                <div class="lang-content-box">
                    ...
                    <div class="panel-footer text-right">
                        ...
                        <span class="btn btn-success" v-on:click="saveMenu">{{__("Save Menu")}}</span>
                    </div>
                </div>
                </div>
            </div>
