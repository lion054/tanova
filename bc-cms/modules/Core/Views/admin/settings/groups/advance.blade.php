    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" data-condition="facebook_enable:is(1)">
                    <label>{{__("Facebook Redirect")}}</label>
                    <div class="form-controls">
                        <input type="text" readonly value="{{url('/social-callback/facebook')}}" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" data-condition="google_enable:is(1)">
                    <label>{{__("Google Redirect")}}</label>
                    <div class="form-controls">
                        <input type="text" readonly value="{{url('/social-callback/google')}}" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        <div class="panel">
            <div class="panel-title"><strong>{{__('X')}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <label> <input type="checkbox" @if(setting_item('twitter_enable') == 1) checked @endif name="twitter_enable" value="1"> {{__("Enable X Login?")}}</label>
                </div>
                <div class="form-group" data-condition="twitter_enable:is(1)">
                    <label>{{__("X Client Id")}}</label>
                    <div class="form-controls">
                        <input type="text" name="twitter_client_id" value="{{setting_item('twitter_client_id')}}" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="twitter_enable:is(1)">
                    <label>{{__("X Client Secret")}}</label>
                    <div class="form-controls">
                        <input type="text" name="twitter_client_secret" value="{{setting_item('twitter_client_secret')}}" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="twitter_enable:is(1)">
                    <label>{{__("X Redirect")}}</label>
                    <div class="form-controls">
                        <input type="text" readonly value="{{url('/social-callback/twitter')}}" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        <div class="panel">
            <div class="panel-title"><strong>{{__('Apple')}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <label> <input type="checkbox" @if(setting_item('apple_enable') == 1) checked @endif name="apple_enable" value="1"> {{__("Enable Apple Login?")}}</label>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label>{{__("Apple Client Id")}}</label>
                    <div class="form-controls">
                        <input type="text" name="apple_client_id" value="{{setting_item('apple_client_id')}}" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label>{{__("Apple Key Id")}}</label>
                    <div class="form-controls">
                        <input type="text" name="apple_key_id" value="{{setting_item('apple_key_id')}}" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label>{{__("Apple Team Id")}}</label>
                    <div class="form-controls">
                        <input type="text" name="apple_team_id" value="{{setting_item('apple_team_id')}}" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label>{{__("Apple Private Key file name")}}</label>
                    <div class="form-controls">
                        <input type="text" name="apple_private_key" value="{{setting_item('apple_private_key')}}" class="form-control">
                    </div>
                    <p><strong>{{__("File name only")}}</strong></p>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <div class="alert alert-warning">
                        {{__("Please upload your apple private key at this folder: :path",['path'=>storage_path('app/')])}}
                    </div>
                </div>
                <div class="form-group" data-condition="apple_enable:is(1)">
                    <label>{{__("Apple Redirect")}}</label>
                    <div class="form-controls">
                        <input type="text" readonly value="{{url('/social-callback/apple')}}" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <select name="cookie_agreement_type" class="form-control mb-3">
                    <option
                        value="" {{ setting_item('cookie_agreement_type') == '' ? 'selected' : ''  }}>{{__('-- Select one --')}}</option>
                    <option
                        value="cookie_consent" {{ setting_item('cookie_agreement_type') == 'cookie_consent' ? 'selected' : ''  }}>{{__('Style 1')}}</option>
                    <option
                        value="cookie_agreement" {{ setting_item('cookie_agreement_type') == 'cookie_agreement' ? 'selected' : ''  }}>{{__("Style 2")}}</option>
                </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <input type="text" name="cookie_agreement_button_text"
                                   value="{{setting_item_with_lang('cookie_agreement_button_text',request()->query('lang')) ?? ''}}"
                                   class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <textarea name="cookie_agreement_content" rows="8"
                                      class="form-control d-none has-ckeditor">{{setting_item_with_lang('cookie_agreement_content',request()->query('lang')) ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
