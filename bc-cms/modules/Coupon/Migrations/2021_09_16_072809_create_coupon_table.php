...
class CreateCouponTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bc_coupons', function (Blueprint $table) {
        ...
        Schema::create('bc_coupon_services', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_booking_coupons', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bc_coupons');
        Schema::dropIfExists('bc_coupon_services');
        Schema::dropIfExists('bc_booking_coupons');
    }
}
