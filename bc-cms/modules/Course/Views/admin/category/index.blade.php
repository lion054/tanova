        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('course.admin.category.bulkEdit')}}" class="filter-form filter-form-left d-flex justify-content-start">
                                {{csrf_field()}}
                            ...
                            <table class="table table-hover">
                                ...
                                @if( count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td width=100px>
                                            @if($row->image_id)
                                            <img class="img-fluid" src="{{get_file_url($row->image_id,'thumb')}}" alt="">
                                            @endif
                                        </td>
                                        <td class="title">
                                            <a href="{{route('course.admin.category.edit',['id'=>$row->id])}}">{{$prefix.' '.$row->name}}</a>
                                        </td>
