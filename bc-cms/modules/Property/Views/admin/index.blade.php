...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("All Properties")}}</h1>
                        ...
                        @if($rows->total() > 0)
                            @foreach($rows as $row)
                                <tr class="{{$row->status}}">
                                    ...
                                    <td class="title">
                                        <a href="{{route('property.admin.edit',['id'=>$row->id])}}">{{$row->title}}</a>
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{route('property.admin.edit',['id'=>$row->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> {{__('Edit')}}
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
