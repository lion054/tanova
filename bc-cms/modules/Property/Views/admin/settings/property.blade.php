                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input
                            ...
                            value="{{setting_item_with_lang('property_page_search_title',request()->query('lang'))}}"
                            class="form-control"
                        >
                    </div>
                </div>
                        ...
                        <div class="form-controls">
                            <label>
                                <input
                                    ...
                                    value="1"
                                    @if(!empty($settings['property_prefix_price_listing'])) checked @endif /> {{__("Yes, please enable it")}}</label>
                            <br>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label>
                                <input
                                    ...
                                    value="1"
                                    @if(!empty($settings['property_thumb_open_gallery'])) checked @endif /> {{__("Yes, please enable it")}}</label>
                            <br>
                        </div>
                    </div>
                @endif
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="property_layout_map_option" class="form-control">
                            <option
                                {{ (setting_item_with_lang('property_layout_map_option',request()->query('lang')) ?? '') == 'map_left' ? 'selected' : '' }} value="map_left"
                            >{{__('Map Left')}}</option>
                            <option
                                {{ (setting_item_with_lang('property_layout_map_option',request()->query('lang')) ?? '') == 'map_right' ? 'selected' : ''  }} value="map_right"
                            >{{__("Map Right")}}</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-controls">
                            <input
                                ...
                                value="{{$settings['property_map_lat_default'] ?? ''}}"
                                class="form-control"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-controls">
                            <input
                                ...
                                value="{{$settings['property_map_lng_default'] ?? ''}}"
                                class="form-control"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-controls">
                            <input
                                ...
                                value="{{$settings['property_map_zoom_default'] ?? ''}}"
                                class="form-control"
                                placeholder="13"
                            >
                        </div>
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config page detail property of your website')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select
                                ...
                                value="{{setting_item_with_lang('property_page_single_layout',request()->query('lang'))}}"
                                class="form-control"
                            >
                                @foreach(config('property.single_layouts') as $type=>$name)
                                    <option
                                        {{setting_item_with_lang('property_page_single_layout',request()->query('lang')) == $type ? 'selected="selected"' : ''}} value="{{$type}}"
                                    >{{$name}}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            @php do_action(\Modules\Property\Hook::PROPERTY_SETTING_AFTER_SINGLE_LAYOUT) @endphp
        </div>
    </div>
@endif
@if(is_default_lang())
                        ...
                        <div class="form-controls">
                            <label>
                                <input
                                    ...
                                    value="1"
                                    @if(!empty($settings['property_enable_review'])) checked @endif /> {{__("Yes, please enable it")}} </label>
                            <br>
                        ...
                        <div class="form-controls">
                            <label>
                                <input
                                    ...
                                    value="1"
                                    @if(!empty($settings['property_review_approved'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="property_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <input
                                ...
                                value="{{ $settings['property_review_number_per_page'] ?? 5 }}"
                            />
                        ...
                        <div class="form-controls">
                            <label>
                                <input
                                    ...
                                    value="1"
                                    @if(!empty($settings['property_vendor_create_service_must_approved_by_admin'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
