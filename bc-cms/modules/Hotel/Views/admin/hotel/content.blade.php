    ...
    <div class="panel-body">
        ...
        @if(is_default_lang())
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__("Hotel Phone")}}</label>
                        <input type="text" value="{{$row->phone}}" placeholder="{{__("Eg: +84 123456789")}}" name="phone" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__("Hotel Website")}}</label>
                        <input type="text" value="{{$row->website}}" placeholder="{{__("https://bookingcore.co")}}" name="website" class="form-control">
                    </div>
                </div>
            </div>
        @endif
