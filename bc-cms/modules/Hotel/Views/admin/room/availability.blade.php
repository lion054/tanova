                                ...
                                @foreach ($rows as $k => $item)
                                    <li class="nav-item event-name ">
                                        <a class="nav-link" data-id="{{ $item->id }}" data-toggle="tab"
                                            ...
                                            title="{{ $item->title }}">#{{ $item->id }} {{ !$hotel && $item->hotel ? ' - '.$item->hotel->title : '' }} - {{ $item->title }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
...
@push('js')
    ...
    <script>
        ...
        const loadDateRoute = '{{ $hotel ? route('hotel.admin.room.availability.loadDates', ['hotel_id' => $hotel->id]) : route('hotel.admin.availability.loadDates') }}';
        const storeDateRoute = '{{ $hotel ? route('hotel.admin.room.availability.store', ['hotel_id' => $hotel->id]) : route('hotel.admin.availability.store') }}';
