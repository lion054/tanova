...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    ...
    Route::get('/bookings','UserController@vendorBookings')->name('user.vendor.bookings');
    Route::post('/bookings/{id}/send-whatsapp','UserController@sendBookingWhatsApp')->name('user.booking.send-whatsapp');
    Route::post('/bookings/{id}/send-email','UserController@sendBookingEmail')->name('user.booking.send-email');
