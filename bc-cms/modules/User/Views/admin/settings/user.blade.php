        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="">{{__("Enable reCapcha Newsletter Subscribe Form")}}</label>
                        <div class="form-controls">
                            <label><input type="checkbox" name="user_enable_subscribe_recaptcha" value="1" @if(!empty($settings['user_enable_subscribe_recaptcha'])) checked @endif /> {{__("On")}} </label>
                            <br>
                            <small class="form-text text-muted">{{__("Turn on the mode for newsletter subscribe form")}}</small>
                        </div>
                    </div>
                </div>
            </div>
