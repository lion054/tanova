...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    protected function validateCheckout($code)
    {
        ...
        // always assign booking to current user if user is logged in and booking does not have customer_id
...
//        event(new VendorLogPayment($booking));
    ...
    protected function savePassengers(Booking $booking, Request $request)
    {
        ...
        // Ignore for visa module
        if ($booking->object_model === 'visa') return;
