...
use Modules\Booking\Traits\HasTicketsFeature;
...
class Booking extends BaseModel
{
    ...
    public static function getBookingHistory($booking_status = false, $customer_id_or_name = false , $vendor_id = false , $service = false , $from = false ,  $to = false )
    {
        ...
        $list_booking->whereIn('object_model', array_merge(array_keys(get_bookable_services()), ['tanova_trip']));
    ...
    public function scopeForVendor(\Illuminate\Database\Eloquent\Builder $query, ?int $vendorId = null): \Illuminate\Database\Eloquent\Builder
    {
        ...
        return $id ? $query->where('vendor_id', $id) : $query->whereRaw('0=1');
    }
}
