...
//
Route::get('media/private/view/{code?}','MediaController@privateFileView')->name('media.private.view');
...
Route::group(['prefix'=>'media'],function(){
    ...
    Route::post('/private/store','MediaController@privateFileStore')->middleware('auth')->name('media.private.store');//
});
