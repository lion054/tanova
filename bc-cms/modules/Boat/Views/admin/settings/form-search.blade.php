                                ...
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        <div class="col-md-7">
                                            ...
                                            <br>
                                            <select name="boat_search_fields[{{$key}}][attr]" class="mt-2 custom-select">
                                    ...
                                    <div class="col-md-7">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text" __name__="boat_search_fields[__number__][title{{$key_lang}}]" class="form-control">
                                                </div>
                                            @endforeach
                                        @else
