(function ($) {
        ...
        methods:{
            ...
            fetchEvents(start,end){
                ...
                var data = {
                    ...
                    id:bc_booking_data.id,
                    for_single:1
                };

                $.ajax({
                    url: bc_booking_i18n.load_dates_url,
                    dataType:"json",
                    type:'get',
                    data:data,
                    beforeSend: function() {
            ...
            addHour(){
                ...
                me.start_date_html = bc_booking_data.start_date_html;
            ...
            availabilityBooking(){
                ...
                me.message2.content = '';
                $.ajax({
                    url: bc_booking_i18n.availability_booking_url,
                    dataType:"json",
                    type:'get',
                    data:data,
                    beforeSend: function() {
    ...
    $(".bc_detail_boat .g-faq .item .header").click(function () {
