...
jQuery(function ($) {
  ...
  $.fn.bravoAutocomplete = function (options) {
    ...
    return this.each(function () {
      ...
      main.append(
        '<div class="bc-autocomplete on-message bg-white px-30 py-30 sm:px-0 sm:py-15 rounded-4"><div class="list-item"></div><div class="message">' +
          textLoading +
          "</div></div>"
      );
...
jQuery(function ($) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.error === true) {
          ...
          const redirect = form.find("input[name=redirect]").val() || data.redirect;
      ...
      error: function (e) {
        ...
        if (typeof e.responseJSON !== "undefined" && typeof e.responseJSON.message != "undefined") {
          form
            .find(".message-error")
            .show()
            .html('<div class="alert alert-danger">' + e.responseJSON.message + "</div>");
        }
  ...
  //Menu
  $(".bc-more-menu").on("click", function (e) {
    $(this).trigger("bc-trigger-menu-mobile");
  });
  $(".bc-menu-mobile .b-close").on("click", function (e) {
  ...
  $(".bc-more-menu-user").on("click", function (e) {
  ...
  function updateGuestCountText(parent) {
    ...
    if (children > 1) {
      ...
      parent
        ...
        .removeClass("d-none")
        .html(parent.find(".render .children .one").data("html").replace(":count", children));
    }
  }
  ...
  $(".bc-video-popup").on("click", function (e) {
    let video_url = $(this).data("src");
    let target = $(this).data("target");
    $(target)
      .find(".bc_embed_video")
      .attr("src", video_url + "?autoplay=0&amp;modestbranding=1&amp;showinfo=0");
      ...
      success: function (res) {
        ...
        if (res.message) {
          if (!res.status) {
            form
              .find(".message_box")
              .append('<div class="text text-danger">' + res.message + "</div>")
              .show();
          } else {
            form
              .find(".message_box")
              .append('<div class="text text-success">' + res.message + "</div>")
              .show();
          }
        }
